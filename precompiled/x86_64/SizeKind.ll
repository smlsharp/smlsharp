...
@a=private unnamed_addr constant<{[4x i8],i32,[74x i8]}><{[4x i8]zeroinitializer,i32 -2147483574,[74x i8]c"src/compiler/compilePhases/recordcompilation/main/SizeKind.sml:21.19(583)\00"}>,align 8
@b=private unnamed_addr constant<{[4x i8],i32,[17x i8]}><{[4x i8]zeroinitializer,i32 -2147483631,[17x i8]c"SizeKind.compare\00"}>,align 8
@c=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i32(i8*)*@_SMLFN8SizeKind7compareE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind7compareE_59 to void(...)*),i32 -2147483647}>,align 8
@d=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLN8SizeKind12generateArgsE_41 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind12generateArgsE_60 to void(...)*),i32 -2147483647}>,align 8
@e=private unnamed_addr constant<{[4x i8],i32,[74x i8]}><{[4x i8]zeroinitializer,i32 -2147483574,[74x i8]c"src/compiler/compilePhases/recordcompilation/main/SizeKind.sml:30.22(872)\00"}>,align 8
@f=private unnamed_addr constant<{[4x i8],i32,[26x i8]}><{[4x i8]zeroinitializer,i32 -2147483622,[26x i8]c"SizeKind.generateInstance\00"}>,align 8
@g=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN8SizeKind16generateInstanceE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_63 to void(...)*),i32 -2147483647}>,align 8
@h=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN8SizeKind11singletonTyE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind11singletonTyE_64 to void(...)*),i32 -2147483647}>,align 8
@_SMLZN8SizeKind11singletonTyE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@h,i64 0,i32 2)to i8*)
@i=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN8SizeKind12generateArgsE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind12generateArgsE_65 to void(...)*),i32 -2147483647}>,align 8
@_SMLZN8SizeKind12generateArgsE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@i,i64 0,i32 2)to i8*)
@_SMLZN8SizeKind7compareE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@c,i64 0,i32 2)to i8*)
@_SMLZN8SizeKind16generateInstanceE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@g,i64 0,i32 2)to i8*)
@_SML_ftabe7a28e6ca37c1b20_SizeKind=external global i8
...
define private void@_SML_tabbe7a28e6ca37c1b20_SizeKind()#3{
unreachable
}
define void@_SML_loade7a28e6ca37c1b20_SizeKind(i8*%a)local_unnamed_addr#0{
...
tail call void@sml_gcroot(i8*%a,void()*@_SML_tabbe7a28e6ca37c1b20_SizeKind,i8*@_SML_ftabe7a28e6ca37c1b20_SizeKind,i8*null)#0
ret void
}
define void@_SML_maine7a28e6ca37c1b20_SizeKind()local_unnamed_addr#2 gc"smlsharp"{
...
define fastcc i32@_SMLFN8SizeKind7compareE(i8*inreg%a)#2 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
...
%s=call fastcc i8*@_SMLFN11TypesBasics7derefTyE(i8*inreg%r)
...
%D=icmp eq i8*%w,null
br i1%D,label%ae,label%E
E:
%F=bitcast i8*%w to i32*
%G=load i32,i32*%F,align 4
%H=icmp eq i32%G,1
br i1%H,label%I,label%ae
I:
%J=getelementptr inbounds i8,i8*%w,i64 4
%K=bitcast i8*%J to i32*
%L=load i32,i32*%K,align 4
%M=icmp eq i8*%y,null
br i1%M,label%ae,label%N
N:
%O=bitcast i8*%y to i32*
%P=load i32,i32*%O,align 4
%Q=icmp eq i32%P,1
br i1%Q,label%R,label%ae
R:
%S=getelementptr inbounds i8,i8*%y,i64 4
...
%ad=tail call fastcc i32@_SMLFN14BoundTypeVarID7compareE(i8*inreg%V)
ret i32%ad
ae:
...
store i8*getelementptr inbounds(<{[4x i8],i32,[74x i8]}>,<{[4x i8],i32,[74x i8]}>*@a,i64 0,i32 2,i64 0),i8**%am,align 8
%an=getelementptr inbounds i8,i8*%ag,i64 16
%ao=bitcast i8*%an to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[17x i8]}>,<{[4x i8],i32,[17x i8]}>*@b,i64 0,i32 2,i64 0),i8**%ao,align 8
...
define internal fastcc i8*@_SMLLN8SizeKind12generateArgsE_41(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
call void@llvm.gcroot(i8**%c,i8*null)#0
...
define internal fastcc i8*@_SMLLN8SizeKind16generateInstanceE_47(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
%f=alloca i8*,align 8
...
%r=call fastcc i8*@_SMLFN11TypeLayout210propertyOfE(i8*inreg%q)
...
store i8*getelementptr inbounds(<{[4x i8],i32,[74x i8]}>,<{[4x i8],i32,[74x i8]}>*@e,i64 0,i32 2,i64 0),i8**%L,align 8
%M=getelementptr inbounds i8,i8*%F,i64 16
%N=bitcast i8*%M to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[26x i8]}>,<{[4x i8],i32,[26x i8]}>*@f,i64 0,i32 2,i64 0),i8**%N,align 8
...
define internal fastcc i8*@_SMLLN8SizeKind16generateInstanceE_48(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
call void@llvm.gcroot(i8**%c,i8*null)#0
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_47 to void(...)*),void(...)**%x,align 8
%y=getelementptr inbounds i8,i8*%r,i64 16
%z=bitcast i8*%y to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_47 to void(...)*),void(...)**%z,align 8
%A=getelementptr inbounds i8,i8*%r,i64 24
%B=bitcast i8*%A to i32*
store i32 -2147483647,i32*%B,align 4
ret i8*%r
}
define internal fastcc i8*@_SMLLN8SizeKind16generateInstanceE_51(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
call void@llvm.gcroot(i8**%c,i8*null)#0
call void@llvm.gcroot(i8**%d,i8*null)#0
...
define internal fastcc i8*@_SMLLN8SizeKind16generateInstanceE_52(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
call void@llvm.gcroot(i8**%c,i8*null)#0
call void@llvm.gcroot(i8**%d,i8*null)#0
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_51 to void(...)*),void(...)**%K,align 8
%L=getelementptr inbounds i8,i8*%E,i64 16
%M=bitcast i8*%L to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_51 to void(...)*),void(...)**%M,align 8
%N=getelementptr inbounds i8,i8*%E,i64 24
%O=bitcast i8*%N to i32*
store i32 -2147483647,i32*%O,align 4
ret i8*%E
}
define fastcc i8*@_SMLFN8SizeKind16generateInstanceE(i8*inreg%a)#2 gc"smlsharp"{
l:
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_48 to void(...)*),void(...)**%B,align 8
%C=getelementptr inbounds i8,i8*%v,i64 16
%D=bitcast i8*%C to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_48 to void(...)*),void(...)**%D,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_52 to void(...)*),void(...)**%T,align 8
%U=getelementptr inbounds i8,i8*%N,i64 16
%V=bitcast i8*%U to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN8SizeKind16generateInstanceE_52 to void(...)*),void(...)**%V,align 8
%W=getelementptr inbounds i8,i8*%N,i64 24
%X=bitcast i8*%W to i32*
store i32 -2147483647,i32*%X,align 4
ret i8*%N
}
define fastcc i8*@_SMLFN8SizeKind11singletonTyE(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
store i8*%a,i8**%b,align 8
...
define fastcc i8*@_SMLFN8SizeKind12generateArgsE(i8*inreg%a)#2 gc"smlsharp"{
%b=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
store i8*%a,i8**%b,align 8
...
br label%f
f:
ret i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@d,i64 0,i32 2)to i8*)
}
define internal fastcc i8*@_SMLLN8SizeKind7compareE_59(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i32@_SMLFN8SizeKind7compareE(i8*inreg%b)
...
define internal fastcc i8*@_SMLLN8SizeKind12generateArgsE_60(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLN8SizeKind12generateArgsE_41(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLN8SizeKind16generateInstanceE_63(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN8SizeKind16generateInstanceE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLN8SizeKind11singletonTyE_64(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN8SizeKind11singletonTyE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLN8SizeKind12generateArgsE_65(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN8SizeKind12generateArgsE(i8*inreg%b)
ret i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@d,i64 0,i32 2)to i8*)
}
