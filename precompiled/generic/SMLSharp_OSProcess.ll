...
@_SMLZN16SMLSharp__Runtime3BugE=external local_unnamed_addr global i8*
@a=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i32(i32)*@_SMLFN18SMLSharp__OSProcess9isSuccessE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN18SMLSharp__OSProcess9isSuccessE_85 to void(...)*),i32 -2147483647}>,align 8
@b=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i32(i8*)*@_SMLFN18SMLSharp__OSProcess6systemE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN18SMLSharp__OSProcess6systemE_86 to void(...)*),i32 -2147483647}>,align 8
@c=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN18SMLSharp__OSProcess6getEnvE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN18SMLSharp__OSProcess6getEnvE_87 to void(...)*),i32 -2147483647}>,align 8
@d=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(void(i8*)*@_SMLFN18SMLSharp__OSProcess5sleepE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN18SMLSharp__OSProcess5sleepE_88 to void(...)*),i32 -2147483647}>,align 8
...
@_SMLZN18SMLSharp__OSProcess7successE=local_unnamed_addr constant i32 0
@_SMLZN18SMLSharp__OSProcess7failureE=local_unnamed_addr constant i32 1
@_SMLZN18SMLSharp__OSProcess9isSuccessE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@a,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess6systemE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@b,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess6atExitE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@e,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess4exitE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@l,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess9terminateE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@p,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess6getEnvE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@c,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess5sleepE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@d,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess7atExit_GE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@f,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess12cancelAtExitE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@i,i64 0,i32 2)to i8*)
@_SMLZN18SMLSharp__OSProcess12rebindAtExitE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@j,i64 0,i32 2)to i8*)
@q=private unnamed_addr global[2x i64][i64 1,i64 sub(i64 ptrtoint(i8*getelementptr inbounds(i8,i8*getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i32 0,i32 0,i32 0),i32 8)to i64),i64 ptrtoint([2x i64]*@q to i64))]
@_SML_ftab19a59bcdb325454c_SMLSharp_OSProcess=external global i8
@r=private unnamed_addr global i8 0
...
declare i32@_SMLFN6IntInf4signE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
declare i32@_SMLFN6Word3212fromLargeIntE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
...
define private void@_SML_tabb19a59bcdb325454c_SMLSharp_OSProcess()#3{
unreachable
}
define void@_SML_load19a59bcdb325454c_SMLSharp_OSProcess(i8*%a)local_unnamed_addr#0{
%b=load i8,i8*@r,align 1
%c=icmp eq i8%b,0
...
tail call void@sml_gcroot(i8*%a,void()*@_SML_tabb19a59bcdb325454c_SMLSharp_OSProcess,i8*@_SML_ftab19a59bcdb325454c_SMLSharp_OSProcess,i8*bitcast([2x i64]*@q to i8*))#0
ret void
}
define void@_SML_main19a59bcdb325454c_SMLSharp_OSProcess()local_unnamed_addr#2 gc"smlsharp"{
%a=load i8,i8*@r,align 1
%b=and i8%a,2
%c=icmp eq i8%b,0
br i1%c,label%e,label%d
d:
...
define fastcc i32@_SMLFN18SMLSharp__OSProcess9isSuccessE(i32 inreg%a)#4 gc"smlsharp"{
%b=icmp eq i32%a,0
%c=zext i1%b to i32
ret i32%c
}
define fastcc i32@_SMLFN18SMLSharp__OSProcess6systemE(i8*inreg%a)#2 gc"smlsharp"personality i32(...)*@sml_personality{
i:
%b=alloca i8*,align 8
...
m:
%n=call fastcc i8*@_SMLFN16SMLSharp__Runtime9OS__SysErrE(i32 inreg 0)
...
call void@sml_enter()#0
%z=call i8*@sml_unsave_exn(i8*inreg%y)#0
resume{i8*,i8*}%x
}
define fastcc i8*@_SMLFN18SMLSharp__OSProcess6getEnvE(i8*inreg%a)#2 gc"smlsharp"personality i32(...)*@sml_personality{
i:
%b=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
store i8*%a,i8**%b,align 8
...
%h=phi i8*[%f,%e],[%a,%i]
call void@sml_leave()#0
%j=call i8*@getenv(i8*%h)
call void@sml_enter()#0
%k=ptrtoint i8*%j to i64
%l=tail call fastcc i8*@_SMLFN16SMLSharp__Runtime14str__new__optionE(i64 inreg%k)
ret i8*%l
}
define fastcc void@_SMLFN18SMLSharp__OSProcess5sleepE(i8*inreg%a)#2 gc"smlsharp"personality i32(...)*@sml_personality{
i:
%b=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
store i8*%a,i8**%b,align 8
...
%h=phi i8*[%f,%e],[%a,%i]
store i8*null,i8**%b,align 8
%j=call fastcc i8*@_SMLFN4Time9toSecondsE(i8*inreg%h)
store i8*%j,i8**%b,align 8
%k=call fastcc i32@_SMLFN6IntInf4signE(i8*inreg%j)
%l=icmp sgt i32%k,0
...
store i8*null,i8**%b,align 8
%p=call fastcc i32@_SMLFN6Word3212fromLargeIntE(i8*inreg%o)
call void@sml_leave()#0
%q=invoke i32@sleep(i32%p)
to label%r unwind label%s
r:
call void@sml_enter()#0
ret void
s:
...
call void@sml_enter()#0
%v=call i8*@sml_unsave_exn(i8*inreg%u)#0
resume{i8*,i8*}%t
}
define fastcc void@_SMLFN18SMLSharp__OSProcess6atExitE(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
...
%j=load i8*,i8**getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2),align 8
store i8*%j,i8**%b,align 8
...
call void@sml_write(i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2)to i8*),i8**inreg getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2),i8*inreg%k)#0
ret void
}
define fastcc i8*@_SMLFN18SMLSharp__OSProcess7atExit_GE(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
call void@llvm.gcroot(i8**%c,i8*null)#0
...
define fastcc void@_SMLFN18SMLSharp__OSProcess12cancelAtExitE(i8*inreg%a)#2 gc"smlsharp"{
t:
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
...
store i8*%a,i8**%b,align 8
%g=load i8*,i8**getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2),align 8
...
store i8*null,i8**%c,align 8
%E=getelementptr inbounds i8*,i8**%D,i64 1
%F=load i8*,i8**%E,align 8
%G=icmp eq i8*%F,null
br i1%G,label%H,label%ab
H:
store i8*null,i8**%d,align 8
%I=load i8*,i8**@_SMLZN16SMLSharp__Runtime3BugE,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[51x i8]}>,<{[4x i8],i32,[51x i8]}>*@g,i64 0,i32 2,i64 0),i8**%P,align 8
%Q=getelementptr inbounds i8,i8*%J,i64 16
%R=bitcast i8*%Q to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[28x i8]}>,<{[4x i8],i32,[28x i8]}>*@h,i64 0,i32 2,i64 0),i8**%R,align 8
...
%ai=call i32@sml_obj_equal(i8*inreg%ad,i8*inreg%ah)#0
%aj=icmp eq i32%ai,0
...
br label%r
aL:
%aM=phi i8*[%bo,%a5],[%al,%ak]
%aN=load i8*,i8**%e,align 8
store i8*null,i8**%e,align 8
%aO=getelementptr inbounds i8,i8*%aM,i64 8
...
call void@sml_write(i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2)to i8*),i8**inreg getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2),i8*inreg%a4)#0
ret void
a5:
%a6=bitcast i8*%aZ to i8**
%a7=load i8*,i8**%a6,align 8
store i8*%a7,i8**%c,align 8
%a8=getelementptr inbounds i8,i8*%aZ,i64 8
%a9=bitcast i8*%a8 to i8**
%ba=load i8*,i8**%a9,align 8
store i8*%ba,i8**%d,align 8
%bb=getelementptr inbounds i8,i8*%aX,i64 8
...
define fastcc void@_SMLFN18SMLSharp__OSProcess12rebindAtExitE(i8*inreg%a)#4 gc"smlsharp"{
...
tail call void@sml_write(i8*inreg%c,i8**inreg%g,i8*inreg%f)#0
ret void
}
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess4exitE_75(i32 inreg%a)#5 gc"smlsharp"personality i32(...)*@sml_personality{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
call void@llvm.gcroot(i8**%c,i8*null)#0
...
br label%g
g:
%h=load i8*,i8**getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2),align 8
call void@sml_write(i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2)to i8*),i8**inreg getelementptr inbounds(<{[4x i8],i32,i8*}>,<{[4x i8],i32,i8*}>*@_SMLDL57,i64 0,i32 2),i8*inreg null)#0
br label%i
i:
%j=phi i8*[%h,%g],[%G,%F]
%k=icmp eq i8*%j,null
br i1%k,label%H,label%l
l:
...
store i8*null,i8**%c,align 8
%C=invoke fastcc i8*%u(i8*inreg%B,i8*inreg%x)
to label%F unwind label%D
D:
%E=landingpad{i8*,i8*}
catch i8*null
br label%F
...
H:
call void@sml_leave()#0
invoke void@prim_GenericOS_exit(i32%a)
to label%I unwind label%ac
I:
call void@sml_enter()#0
%J=load i8*,i8**@_SMLZN16SMLSharp__Runtime3BugE,align 8
store i8*%J,i8**%b,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[49x i8]}>,<{[4x i8],i32,[49x i8]}>*@m,i64 0,i32 2,i64 0),i8**%Q,align 8
%R=getelementptr inbounds i8,i8*%K,i64 16
%S=bitcast i8*%R to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[21x i8]}>,<{[4x i8],i32,[21x i8]}>*@n,i64 0,i32 2,i64 0),i8**%S,align 8
...
call void@sml_enter()#0
%af=call i8*@sml_unsave_exn(i8*inreg%ae)#0
resume{i8*,i8*}%ad
}
define fastcc i8*@_SMLFN18SMLSharp__OSProcess4exitE(i32 inreg%a,i32 inreg%b)#4 gc"smlsharp"{
ret i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@k,i64 0,i32 2)to i8*)
}
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess9terminateE_81(i32 inreg%a)#5 gc"smlsharp"personality i32(...)*@sml_personality{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
call void@llvm.gcroot(i8**%c,i8*null)#0
...
%o=getelementptr inbounds i8,i8*%j,i64 8
%p=bitcast i8*%o to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[49x i8]}>,<{[4x i8],i32,[49x i8]}>*@m,i64 0,i32 2,i64 0),i8**%p,align 8
%q=getelementptr inbounds i8,i8*%j,i64 16
%r=bitcast i8*%q to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[21x i8]}>,<{[4x i8],i32,[21x i8]}>*@n,i64 0,i32 2,i64 0),i8**%r,align 8
%s=getelementptr inbounds i8,i8*%j,i64 24
%t=bitcast i8*%s to i32*
store i32 7,i32*%t,align 4
%u=call i8*@sml_alloc(i32 inreg 60)#0
...
call void@sml_enter()#0
%E=call i8*@sml_unsave_exn(i8*inreg%D)#0
resume{i8*,i8*}%C
}
define fastcc i8*@_SMLFN18SMLSharp__OSProcess9terminateE(i32 inreg%a,i32 inreg%b)#4 gc"smlsharp"{
ret i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@o,i64 0,i32 2)to i8*)
}
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess9isSuccessE_85(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
...
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess6systemE_86(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i32@_SMLFN18SMLSharp__OSProcess6systemE(i8*inreg%b)
...
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess6getEnvE_87(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN18SMLSharp__OSProcess6getEnvE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess5sleepE_88(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
tail call fastcc void@_SMLFN18SMLSharp__OSProcess5sleepE(i8*inreg%b)
...
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess6atExitE_89(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
tail call fastcc void@_SMLFN18SMLSharp__OSProcess6atExitE(i8*inreg%b)
%c=tail call i8*@sml_alloc(i32 inreg 4)#0
%d=bitcast i8*%c to i32*
%e=getelementptr inbounds i8,i8*%c,i64 -4
%f=bitcast i8*%e to i32*
...
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess7atExit_GE_90(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN18SMLSharp__OSProcess7atExit_GE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess12cancelAtExitE_91(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
tail call fastcc void@_SMLFN18SMLSharp__OSProcess12cancelAtExitE(i8*inreg%b)
%c=tail call i8*@sml_alloc(i32 inreg 4)#0
%d=bitcast i8*%c to i32*
%e=getelementptr inbounds i8,i8*%c,i64 -4
%f=bitcast i8*%e to i32*
...
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess12rebindAtExitE_92(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
tail call fastcc void@_SMLFN18SMLSharp__OSProcess12rebindAtExitE(i8*inreg%b)
%c=tail call i8*@sml_alloc(i32 inreg 4)#0
%d=bitcast i8*%c to i32*
%e=getelementptr inbounds i8,i8*%c,i64 -4
%f=bitcast i8*%e to i32*
...
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess4exitE_93(i8*inreg%a,i8*inreg%b)#5 gc"smlsharp"{
%c=bitcast i8*%b to i32*
%d=load i32,i32*%c,align 4
%e=tail call fastcc i8*@_SMLLLN18SMLSharp__OSProcess4exitE_75(i32 inreg%d)
unreachable
}
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess4exitE_94(i8*inreg%a,i8*inreg%b,i8*inreg%c)#4 gc"smlsharp"{
ret i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@k,i64 0,i32 2)to i8*)
}
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess9terminateE_95(i8*inreg%a,i8*inreg%b)#5 gc"smlsharp"{
%c=bitcast i8*%b to i32*
%d=load i32,i32*%c,align 4
%e=tail call fastcc i8*@_SMLLLN18SMLSharp__OSProcess9terminateE_81(i32 inreg%d)
unreachable
}
define internal fastcc i8*@_SMLLLN18SMLSharp__OSProcess9terminateE_96(i8*inreg%a,i8*inreg%b,i8*inreg%c)#4 gc"smlsharp"{
ret i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@o,i64 0,i32 2)to i8*)
}
