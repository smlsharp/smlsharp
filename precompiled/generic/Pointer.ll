...
@b=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN7Pointer11importBytesE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN7Pointer11importBytesE_45 to void(...)*),i32 -2147483647}>,align 8
@c=private unnamed_addr constant<{[4x i8],i32,[37x i8]}><{[4x i8]zeroinitializer,i32 -2147483611,[37x i8]c"src/ffi/main/Pointer.sml:42.28(1077)\00"}>,align 8
@d=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN7Pointer13importString_GE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN7Pointer13importString_GE_46 to void(...)*),i32 -2147483647}>,align 8
@e=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i32(i64)*@_SMLLN7Pointer6isNullE_39 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN7Pointer6isNullE_47 to void(...)*),i32 -2147483647}>,align 8
@f=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i32,i32)*@_SMLFN7Pointer6isNullE to void(...)*),void(...)*bitcast(i8*(i8*,i8*,i8*)*@_SMLLN7Pointer6isNullE_48 to void(...)*),i32 -2147483647}>,align 8
@_SMLZN7Pointer6isNullE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@f,i64 0,i32 2)to i8*)
...
@g=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i64)*@_SMLFN7Pointer12importStringE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLN7Pointer12importStringE_49 to void(...)*),i32 -2147483647}>,align 8
@_SMLZN7Pointer12importStringE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@g,i64 0,i32 2)to i8*)
@_SMLZN7Pointer13importString_GE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@d,i64 0,i32 2)to i8*)
...
%T=call i8*@sml_save()#0
%U=invoke i8*@prim_UnmanagedMemory_import(i8*%I,i32%m)
...
%v=getelementptr inbounds i8,i8*%q,i64 8
%w=bitcast i8*%v to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[37x i8]}>,<{[4x i8],i32,[37x i8]}>*@c,i64 0,i32 2,i64 0),i8**%w,align 8
%x=getelementptr inbounds i8,i8*%q,i64 16
%y=bitcast i8*%x to i32*
store i32 3,i32*%y,align 4
%z=call i8*@sml_alloc(i32 inreg 60)#0
...
store i32 0,i32*%S,align 4
%T=call i8*@sml_save()#0
%U=invoke i8*@sml_str_new2(i8*%I,i32%m)
to label%V unwind label%W
V:
call void@sml_unsave()#0
ret i8*%U
...
define internal fastcc i32@_SMLLN7Pointer6isNullE_39(i64 inreg%a)#3 gc"smlsharp"{
%b=icmp eq i64%a,0
%c=zext i1%b to i32
ret i32%c
}
...
define internal fastcc i8*@_SMLLN7Pointer11importBytesE_45(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN7Pointer11importBytesE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLN7Pointer13importString_GE_46(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN7Pointer13importString_GE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLN7Pointer6isNullE_47(i8*inreg%a,i8*inreg%b)#3 gc"smlsharp"{
...
define internal fastcc i8*@_SMLLN7Pointer6isNullE_48(i8*inreg%a,i8*inreg%b,i8*inreg%c)#3 gc"smlsharp"{
ret i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@e,i64 0,i32 2)to i8*)
}
define internal fastcc i8*@_SMLLN7Pointer12importStringE_49(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=bitcast i8*%b to i64*
%d=load i64,i64*%c,align 4
