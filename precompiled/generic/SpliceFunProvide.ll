...
@_SMLZN13NameEvalError23ProvideUndefinedFunctorE=external local_unnamed_addr global i8*
@_SMLZN7LibBase8NotFoundE=external local_unnamed_addr global i8*
@_SMLZ5Match=external unnamed_addr constant i8*
@a=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLLN21SpliceProvicdeFundecl13spliceFunbindE_40 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN21SpliceProvicdeFundecl13spliceFunbindE_54 to void(...)*),i32 -2147483647}>,align 8
@b=private unnamed_addr constant<{[4x i8],i32,[79x i8]}><{[4x i8]zeroinitializer,i32 -2147483569,[79x i8]c"src/compiler/compilePhases/nameevaluation/main/SpliceFunProvide.sml:38.6(1122)\00"}>,align 8
@c=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLLN21SpliceProvicdeFundecl12spliceTopdecE_43 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN21SpliceProvicdeFundecl12spliceTopdecE_55 to void(...)*),i32 -2147483647}>,align 8
@d=private unnamed_addr constant<{[4x i8],i32,[79x i8]}><{[4x i8]zeroinitializer,i32 -2147483569,[79x i8]c"src/compiler/compilePhases/nameevaluation/main/SpliceFunProvide.sml:18.16(404)\00"}>,align 8
@e=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLL10fundeclEnv_46 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLL10fundeclEnv_56 to void(...)*),i32 -2147483647}>,align 8
@f=private unnamed_addr constant<{[4x i8],i32,[80x i8]}><{[4x i8]zeroinitializer,i32 -2147483568,[80x i8]c"src/compiler/compilePhases/nameevaluation/main/SpliceFunProvide.sml:72.25(2481)\00"}>,align 8
@g=private unnamed_addr constant<{[4x i8],i32,[4x i8]}><{[4x i8]zeroinitializer,i32 -2147483644,[4x i8]c"200\00"}>,align 8
...
%A=invoke fastcc i8*@_SMLFN9SymbolEnv6removeE(i32 inreg 1,i32 inreg 8)
to label%B unwind label%aK
B:
...
%S=invoke fastcc i8*%E(i8*inreg%R,i8*inreg%H)
to label%T unwind label%aK
T:
...
%aR=load i8*,i8**@_SMLZN7LibBase8NotFoundE,align 8
%aS=icmp eq i8*%aQ,%aR
br i1%aS,label%aT,label%bn
aT:
store i8*null,i8**%c,align 8
...
define internal fastcc i8*@_SMLLLN21SpliceProvicdeFundecl12spliceTopdecE_43(i8*inreg%a)#2 gc"smlsharp"{
m:
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[79x i8]}>,<{[4x i8],i32,[79x i8]}>*@b,i64 0,i32 2,i64 0),i8**%H,align 8
...
%ag=call fastcc i8*%ad(i8*inreg%af,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@a,i64 0,i32 2)to i8*))
...
store i8*null,i8**%f,align 8
%aw=call fastcc i8*%aj(i8*inreg%av,i8*inreg%am)
...
%aJ=call fastcc i8*@_SMLFN4List3revE(i32 inreg 1,i32 inreg 8)
...
ret i8*%bk
bu:
%bv=getelementptr inbounds i8,i8*%o,i64 8
...
ret i8*%b8
ci:
%cj=getelementptr inbounds i8,i8*%o,i64 8
...
define internal fastcc i8*@_SMLLL10fundeclEnv_46(i8*inreg%a)#2 gc"smlsharp"{
l:
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[79x i8]}>,<{[4x i8],i32,[79x i8]}>*@d,i64 0,i32 2,i64 0),i8**%B,align 8
...
define internal fastcc void@_SMLLLN21SpliceProvicdeFundecl20spliceProvideFundeclE_50(i8*inreg%a)#2 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
%o=load i8*,i8**%n,align 8
store i8*%o,i8**%b,align 8
%p=call fastcc i8*@_SMLFN6Symbol11symbolToLocE(i8*inreg%o)
store i8*%p,i8**%c,align 8
%q=load i8*,i8**@_SMLZN13NameEvalError23ProvideUndefinedFunctorE,align 8
store i8*%q,i8**%d,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[4x i8]}>,<{[4x i8],i32,[4x i8]}>*@g,i64 0,i32 2,i64 0),i8**%B,align 8
...
%N=bitcast i8*%M to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[80x i8]}>,<{[4x i8],i32,[80x i8]}>*@f,i64 0,i32 2,i64 0),i8**%N,align 8
...
tail call fastcc void@_SMLFN14UserErrorUtils12enqueueErrorE(i8*inreg%T)
ret void
}
define fastcc i8*@_SMLFN21SpliceProvicdeFundecl20spliceProvideFundeclE(i8*inreg%a)#2 gc"smlsharp"{
m:
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
...
%K=call fastcc i8*%H(i8*inreg%J,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@e,i64 0,i32 2)to i8*))
...
%Q=call fastcc i8*@_SMLFN9SymbolEnv5emptyE(i32 inreg 1,i32 inreg 8)
%R=load i8*,i8**%f,align 8
store i8*null,i8**%f,align 8
%S=call fastcc i8*%N(i8*inreg%R,i8*inreg%Q)
...
%aN=bitcast i8*%aJ to i8**
%aO=load i8*,i8**%aN,align 8
%aP=call fastcc i8*%aM(i8*inreg%aO,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@c,i64 0,i32 2)to i8*))
...
store i8*null,i8**%f,align 8
%a5=call fastcc i8*%aS(i8*inreg%a4,i8*inreg%aV)
...
%bi=call fastcc i8*@_SMLFN9SymbolEnv3appE(i32 inreg 1,i32 inreg 8)
...
%bo=call fastcc i8*%bl(i8*inreg%bn,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@h,i64 0,i32 2)to i8*))
...
%bw=call fastcc i8*@_SMLFN4List3revE(i32 inreg 1,i32 inreg 8)
...
%bE=call fastcc i8*@_SMLFN4List3revE(i32 inreg 1,i32 inreg 8)
...
define internal fastcc i8*@_SMLLLN21SpliceProvicdeFundecl13spliceFunbindE_54(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLLN21SpliceProvicdeFundecl13spliceFunbindE_40(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN21SpliceProvicdeFundecl12spliceTopdecE_55(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLLN21SpliceProvicdeFundecl12spliceTopdecE_43(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLL10fundeclEnv_56(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLL10fundeclEnv_46(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN21SpliceProvicdeFundecl20spliceProvideFundeclE_57(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
tail call fastcc void@_SMLLLN21SpliceProvicdeFundecl20spliceProvideFundeclE_50(i8*inreg%b)
...
define internal fastcc i8*@_SMLLLN21SpliceProvicdeFundecl20spliceProvideFundeclE_58(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN21SpliceProvicdeFundecl20spliceProvideFundeclE(i8*inreg%b)
ret i8*%c
}
