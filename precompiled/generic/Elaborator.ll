...
@_SMLZN13UserTvarScope15decideInterfaceE=external local_unnamed_addr global i8*
@_SMLZN14ElaborateError22ProvideInfixNotDefinedE=external local_unnamed_addr global i8*
@_SMLZN9UserError10UserErrorsE=external local_unnamed_addr global i8*
@a=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLLN10Elaborator12extendFixEnvE_40 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator12extendFixEnvE_67 to void(...)*),i32 -2147483647}>,align 8
@b=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN10Elaborator12extendFixEnvE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator12extendFixEnvE_68 to void(...)*),i32 -2147483647}>,align 8
@c=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLL6fixEnv_44 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLL6fixEnv_69 to void(...)*),i32 -2147483647}>,align 8
@d=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLL6fixEnv_46 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLL6fixEnv_70 to void(...)*),i32 -2147483647}>,align 8
@e=private unnamed_addr constant<{[4x i8],i32,[69x i8]}><{[4x i8]zeroinitializer,i32 -2147483579,[69x i8]c"src/compiler/compilePhases/elaborate/main/Elaborator.sml:52.41(1901)\00"}>,align 8
@f=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLLN10Elaborator9elaborateE_49 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator9elaborateE_71 to void(...)*),i32 -2147483647}>,align 8
@g=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLLN10Elaborator9elaborateE_51 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator9elaborateE_72 to void(...)*),i32 -2147483647}>,align 8
@h=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLLN10Elaborator9elaborateE_53 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator9elaborateE_73 to void(...)*),i32 -2147483647}>,align 8
@i=private unnamed_addr constant<{[4x i8],i32,[69x i8]}><{[4x i8]zeroinitializer,i32 -2147483579,[69x i8]c"src/compiler/compilePhases/elaborate/main/Elaborator.sml:64.16(2375)\00"}>,align 8
@j=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN10Elaborator9elaborateE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator9elaborateE_74 to void(...)*),i32 -2147483647}>,align 8
@k=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLL6fixEnv_59 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLL6fixEnv_75 to void(...)*),i32 -2147483647}>,align 8
@l=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLL12resultFixEnv_61 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLL12resultFixEnv_76 to void(...)*),i32 -2147483647}>,align 8
@m=private unnamed_addr constant<{[4x i8],i32,[69x i8]}><{[4x i8]zeroinitializer,i32 -2147483579,[69x i8]c"src/compiler/compilePhases/elaborate/main/Elaborator.sml:93.16(3659)\00"}>,align 8
@n=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN10Elaborator18elaborateInterfaceE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator18elaborateInterfaceE_77 to void(...)*),i32 -2147483647}>,align 8
...
declare i8*@_SMLFN13UserTvarScope15decideInterfaceE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
declare i8*@_SMLFN13UserTvarScope6decideE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
...
declare i8*@_SMLFN15ElaborateModule11elabTopDecsE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
declare i8*@_SMLFN18ElaborateInterface9elaborateE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
...
define fastcc i8*@_SMLFN10Elaborator12extendFixEnvE(i8*inreg%a)#2 gc"smlsharp"{
k:
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
...
define internal fastcc i8*@_SMLLL6fixEnv_44(i8*inreg%a)#4 gc"smlsharp"{
%b=getelementptr inbounds i8,i8*%a,i64 8
%c=bitcast i8*%b to i8**
%d=load i8*,i8**%c,align 8
ret i8*%d
}
define internal fastcc i8*@_SMLLL6fixEnv_46(i8*inreg%a)#4 gc"smlsharp"{
%b=getelementptr inbounds i8,i8*%a,i64 8
%c=bitcast i8*%b to i8**
%d=load i8*,i8**%c,align 8
ret i8*%d
}
define internal fastcc i8*@_SMLLLN10Elaborator9elaborateE_49(i8*inreg%a)#2 gc"smlsharp"{
m:
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
...
%z=icmp eq i8*%y,null
br i1%z,label%A,label%Z
A:
%B=load i8*,i8**@_SMLZN14ElaborateError22ProvideInfixNotDefinedE,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[69x i8]}>,<{[4x i8],i32,[69x i8]}>*@e,i64 0,i32 2,i64 0),i8**%I,align 8
%J=load i8*,i8**%b,align 8
...
define internal fastcc i8*@_SMLLLN10Elaborator9elaborateE_51(i8*inreg%a)#2 gc"smlsharp"{
%b=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
store i8*%a,i8**%b,align 8
...
define internal fastcc i8*@_SMLLLN10Elaborator9elaborateE_53(i8*inreg%a)#2 gc"smlsharp"{
%b=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
store i8*%a,i8**%b,align 8
%c=load atomic i32,i32*@sml_check_flag unordered,align 4
...
define internal fastcc i8*@_SMLLLN10Elaborator9elaborateE_56(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
p:
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
x:
%y=call fastcc i8*@_SMLFN9SymbolEnv5emptyE(i32 inreg 1,i32 inreg 8)
store i8*%y,i8**%c,align 8
%z=call fastcc i8*@_SMLFN9SymbolEnv5emptyE(i32 inreg 1,i32 inreg 8)
...
br label%as
K:
%L=bitcast i8*%v to i8**
%M=load i8*,i8**%L,align 8
%N=call fastcc i8*@_SMLFN18ElaborateInterface9elaborateE(i8*inreg%M)
%O=bitcast i8*%N to i8**
%P=load i8*,i8**%O,align 8
store i8*%P,i8**%c,align 8
...
as:
%at=phi i8*[%ag,%K],[%A,%x]
%au=phi i8*[%ar,%K],[null,%x]
%av=phi i8*[%ao,%K],[%H,%x]
%aw=phi i8*[%al,%K],[%E,%x]
%ax=phi i8*[%aj,%K],[null,%x]
%ay=getelementptr inbounds i8,i8*%at,i64 24
%az=bitcast i8*%ay to i8**
store i8*%au,i8**%az,align 8
%aA=getelementptr inbounds i8,i8*%at,i64 32
%aB=bitcast i8*%aA to i32*
...
%aC=call fastcc i8*@_SMLFN6Option3mapE(i32 inreg 1,i32 inreg 8,i32 inreg 1,i32 inreg 8)
...
%aI=load i8*,i8**@_SMLZN13UserTvarScope15decideInterfaceE,align 8
...
%aR=call fastcc i8*@_SMLFN9SymbolEnv9unionWithE(i32 inreg 1,i32 inreg 8)
...
%aX=call fastcc i8*%aU(i8*inreg%aW,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@c,i64 0,i32 2)to i8*))
...
%bi=call fastcc i8*@_SMLFN15ElaborateModule11elabTopDecsE(i8*inreg%bh)
...
%bv=call fastcc i8*@_SMLFN13UserTvarScope6decideE(i8*inreg%br)
store i8*%bv,i8**%h,align 8
%bw=call fastcc i8*@_SMLFN9SymbolEnv9unionWithE(i32 inreg 1,i32 inreg 8)
...
%bC=call fastcc i8*%bz(i8*inreg%bB,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@d,i64 0,i32 2)to i8*))
...
%bU=call fastcc i8*@_SMLFN15ElaborateModule11elabTopDecsE(i8*inreg%bT)
...
%b7=call fastcc i8*@_SMLFN13UserTvarScope6decideE(i8*inreg%b3)
store i8*%b7,i8**%e,align 8
%b8=call fastcc i8*@_SMLFN9SymbolEnv10mergeWithiE(i32 inreg 1,i32 inreg 8,i32 inreg 1,i32 inreg 8,i32 inreg 1,i32 inreg 8)
...
%ce=call fastcc i8*%cb(i8*inreg%cd,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@f,i64 0,i32 2)to i8*))
...
%ck=call fastcc i8*@_SMLFN9SymbolEnv4mapiE(i32 inreg 1,i32 inreg 8,i32 inreg 1,i32 inreg 8)
...
%cq=call fastcc i8*%cn(i8*inreg%cp,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@g,i64 0,i32 2)to i8*))
...
%cy=call fastcc i8*@_SMLFN9SymbolEnv4mapiE(i32 inreg 1,i32 inreg 8,i32 inreg 1,i32 inreg 8)
%cz=getelementptr inbounds i8,i8*%cy,i64 16
%cA=bitcast i8*%cz to i8*(i8*,i8*)**
%cB=load i8*(i8*,i8*)*,i8*(i8*,i8*)**%cA,align 8
%cC=bitcast i8*%cy to i8**
%cD=load i8*,i8**%cC,align 8
%cE=call fastcc i8*%cB(i8*inreg%cD,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@h,i64 0,i32 2)to i8*))
%cF=getelementptr inbounds i8,i8*%cE,i64 16
%cG=bitcast i8*%cF to i8*(i8*,i8*)**
%cH=load i8*(i8*,i8*)*,i8*(i8*,i8*)**%cG,align 8
%cI=bitcast i8*%cE to i8**
...
%db=call fastcc i8*@_SMLFN14UserErrorUtils9getErrorsE(i32 inreg 0)
%dc=icmp eq i8*%db,null
br i1%dc,label%dd,label%ds
dd:
%de=call fastcc i8*@_SMLFN14UserErrorUtils11getWarningsE(i32 inreg 0)
...
store i8*null,i8**%d,align 8
store i8*null,i8**%f,align 8
%dt=load i8*,i8**@_SMLZN9UserError10UserErrorsE,align 8
store i8*%dt,i8**%c,align 8
%du=call fastcc i8*@_SMLFN14UserErrorUtils20getErrorsAndWarningsE(i32 inreg 0)
...
store i8*getelementptr inbounds(<{[4x i8],i32,[69x i8]}>,<{[4x i8],i32,[69x i8]}>*@i,i64 0,i32 2,i64 0),i8**%dB,align 8
...
define fastcc i8*@_SMLFN10Elaborator9elaborateE(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
call void@llvm.gcroot(i8**%c,i8*null)#0
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator9elaborateE_56 to void(...)*),void(...)**%q,align 8
%r=getelementptr inbounds i8,i8*%k,i64 16
%s=bitcast i8*%r to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator9elaborateE_56 to void(...)*),void(...)**%s,align 8
%t=getelementptr inbounds i8,i8*%k,i64 24
%u=bitcast i8*%t to i32*
store i32 -2147483647,i32*%u,align 4
ret i8*%k
}
define internal fastcc i8*@_SMLLL6fixEnv_59(i8*inreg%a)#4 gc"smlsharp"{
%b=getelementptr inbounds i8,i8*%a,i64 8
%c=bitcast i8*%b to i8**
%d=load i8*,i8**%c,align 8
ret i8*%d
}
define internal fastcc i8*@_SMLLL12resultFixEnv_61(i8*inreg%a)#4 gc"smlsharp"{
%b=getelementptr inbounds i8,i8*%a,i64 8
%c=bitcast i8*%b to i8**
%d=load i8*,i8**%c,align 8
ret i8*%d
}
define internal fastcc i8*@_SMLLLN10Elaborator18elaborateInterfaceE_64(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
n:
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
%F=getelementptr inbounds i8,i8*%w,i64 32
...
%R=call fastcc i8*@_SMLFN18ElaborateInterface9elaborateE(i8*inreg%H)
...
%aa=call fastcc i8*@_SMLFN13UserTvarScope15decideInterfaceE(i8*inreg%T)
...
%ah=call fastcc i8*%ae(i8*inreg%ag,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@k,i64 0,i32 2)to i8*))
...
store i8*null,i8**%g,align 8
%aB=call fastcc i8*%ak(i8*inreg%aA,i8*inreg%aq)
%aC=call fastcc i8*@_SMLFN15ElaborateModule11elabTopDecsE(i8*inreg%aB)
%aD=getelementptr inbounds i8,i8*%aC,i64 16
%aE=bitcast i8*%aD to i8*(i8*,i8*)**
%aF=load i8*(i8*,i8*)*,i8*(i8*,i8*)**%aE,align 8
%aG=bitcast i8*%aC to i8**
...
%aP=call fastcc i8*@_SMLFN13UserTvarScope6decideE(i8*inreg%aL)
store i8*%aP,i8**%f,align 8
%aQ=call fastcc i8*@_SMLFN9SymbolEnv9unionWithE(i32 inreg 1,i32 inreg 8)
...
%aW=call fastcc i8*%aT(i8*inreg%aV,i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@l,i64 0,i32 2)to i8*))
...
%bh=getelementptr inbounds i8*,i8**%bf,i64 3
...
%bw=call fastcc i8*@_SMLFN14UserErrorUtils9getErrorsE(i32 inreg 0)
%bx=icmp eq i8*%bw,null
br i1%bx,label%by,label%bN
by:
%bz=call fastcc i8*@_SMLFN14UserErrorUtils11getWarningsE(i32 inreg 0)
...
bN:
store i8*null,i8**%d,align 8
%bO=load i8*,i8**@_SMLZN9UserError10UserErrorsE,align 8
store i8*%bO,i8**%c,align 8
%bP=call fastcc i8*@_SMLFN14UserErrorUtils20getErrorsAndWarningsE(i32 inreg 0)
...
store i8*getelementptr inbounds(<{[4x i8],i32,[69x i8]}>,<{[4x i8],i32,[69x i8]}>*@m,i64 0,i32 2,i64 0),i8**%bW,align 8
...
define fastcc i8*@_SMLFN10Elaborator18elaborateInterfaceE(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
call void@llvm.gcroot(i8**%c,i8*null)#0
...
%p=getelementptr inbounds i8,i8*%k,i64 8
%q=bitcast i8*%p to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator18elaborateInterfaceE_64 to void(...)*),void(...)**%q,align 8
%r=getelementptr inbounds i8,i8*%k,i64 16
%s=bitcast i8*%r to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN10Elaborator18elaborateInterfaceE_64 to void(...)*),void(...)**%s,align 8
%t=getelementptr inbounds i8,i8*%k,i64 24
%u=bitcast i8*%t to i32*
store i32 -2147483647,i32*%u,align 4
ret i8*%k
}
define internal fastcc i8*@_SMLLLN10Elaborator12extendFixEnvE_67(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=getelementptr inbounds i8,i8*%b,i64 8
%d=bitcast i8*%c to i8**
%e=load i8*,i8**%d,align 8
ret i8*%e
}
define internal fastcc i8*@_SMLLLN10Elaborator12extendFixEnvE_68(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN10Elaborator12extendFixEnvE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLL6fixEnv_69(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=getelementptr inbounds i8,i8*%b,i64 8
%d=bitcast i8*%c to i8**
%e=load i8*,i8**%d,align 8
ret i8*%e
}
define internal fastcc i8*@_SMLLL6fixEnv_70(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=getelementptr inbounds i8,i8*%b,i64 8
%d=bitcast i8*%c to i8**
%e=load i8*,i8**%d,align 8
ret i8*%e
}
define internal fastcc i8*@_SMLLLN10Elaborator9elaborateE_71(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLLN10Elaborator9elaborateE_49(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN10Elaborator9elaborateE_72(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLLN10Elaborator9elaborateE_51(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN10Elaborator9elaborateE_73(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLLN10Elaborator9elaborateE_53(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN10Elaborator9elaborateE_74(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN10Elaborator9elaborateE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLL6fixEnv_75(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=getelementptr inbounds i8,i8*%b,i64 8
%d=bitcast i8*%c to i8**
%e=load i8*,i8**%d,align 8
ret i8*%e
}
define internal fastcc i8*@_SMLLL12resultFixEnv_76(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=getelementptr inbounds i8,i8*%b,i64 8
%d=bitcast i8*%c to i8**
%e=load i8*,i8**%d,align 8
ret i8*%e
}
define internal fastcc i8*@_SMLLLN10Elaborator18elaborateInterfaceE_77(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN10Elaborator18elaborateInterfaceE(i8*inreg%b)
ret i8*%c
}
