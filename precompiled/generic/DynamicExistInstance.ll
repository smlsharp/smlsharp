...
@a=private unnamed_addr constant<{[4x i8],i32,[86x i8]}><{[4x i8]zeroinitializer,i32 -2147483562,[86x i8]c"src/compiler/compilePhases/recordcompilation/main/DynamicExistInstance.sml:22.20(571)\00"}>,align 8
@b=private unnamed_addr constant<{[4x i8],i32,[7x i8]}><{[4x i8]zeroinitializer,i32 -2147483641,[7x i8]c"TLAPPM\00"}>,align 8
@c=private unnamed_addr constant<{[4x i8],i32,[87x i8]}><{[4x i8]zeroinitializer,i32 -2147483561,[87x i8]c"src/compiler/compilePhases/recordcompilation/main/DynamicExistInstance.sml:88.18(3002)\00"}>,align 8
@d=private unnamed_addr constant<{[4x i8],i32,[39x i8]}><{[4x i8]zeroinitializer,i32 -2147483609,[39x i8]c"DynamicExistInstance.generateExtraArgs\00"}>,align 8
@e=private unnamed_addr constant<{[4x i8],i32,[4x i8]}><{[4x i8]zeroinitializer,i32 -2147483644,[4x i8]c"tag\00"}>,align 8
@f=private unnamed_addr constant<{[4x i8],i32,[5x i8]}><{[4x i8]zeroinitializer,i32 -2147483643,[5x i8]c"size\00"}>,align 8
@g=private unnamed_addr constant<{[4x i8],i32,[6x i8]}><{[4x i8]zeroinitializer,i32 -2147483642,[6x i8]c"reify\00"}>,align 8
@h=private unnamed_addr constant<{[4x i8],i32,[87x i8]}><{[4x i8]zeroinitializer,i32 -2147483561,[87x i8]c"src/compiler/compilePhases/recordcompilation/main/DynamicExistInstance.sml:35.25(1106)\00"}>,align 8
@i=private unnamed_addr constant<{[4x i8],i32,[87x i8]}><{[4x i8]zeroinitializer,i32 -2147483561,[87x i8]c"src/compiler/compilePhases/recordcompilation/main/DynamicExistInstance.sml:36.19(1145)\00"}>,align 8
@j=private unnamed_addr constant<{[4x i8],i32,[9x i8]}><{[4x i8]zeroinitializer,i32 -2147483639,[9x i8]c"TLSELECT\00"}>,align 8
@k=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN20DynamicExistInstance17generateExtraArgsE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_81 to void(...)*),i32 -2147483647}>,align 8
@_SMLZN20DynamicExistInstance17generateExtraArgsE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@k,i64 0,i32 2)to i8*)
@_SML_ftab169d2fa3426ad727_DynamicExistInstance=external global i8
@l=private unnamed_addr global i8 0
...
declare i8*@_SMLFN18UserLevelPrimitive24REIFY__tyCon__existInstMapE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
declare i8*@_SMLFN18UserLevelPrimitive33REIFY__exInfo__dynamicExistInstanceE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
declare i8*@_SMLFN4List3mapE(i32 inreg,i32 inreg,i32 inreg,i32 inreg)local_unnamed_addr#2 gc"smlsharp"
declare i32@_SMLFN9ExistTyID5toIntE(i32 inreg)local_unnamed_addr#2 gc"smlsharp"
...
define void@_SML_load169d2fa3426ad727_DynamicExistInstance(i8*%a)local_unnamed_addr#0{
%b=load i8,i8*@l,align 1
%c=icmp eq i8%b,0
...
define void@_SML_main169d2fa3426ad727_DynamicExistInstance()local_unnamed_addr#2 gc"smlsharp"{
%a=load i8,i8*@l,align 1
%b=and i8%a,2
%c=icmp eq i8%b,0
br i1%c,label%e,label%d
d:
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_41(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_42(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=bitcast i8*%a to i8**
%d=load i8*,i8**%c,align 8
ret i8*%d
}
define internal fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_45(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
%f=alloca i8*,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_46(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
call void@llvm.gcroot(i8**%c,i8*null)#0
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_49(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
%f=alloca i8*,align 8
...
%bc=getelementptr inbounds i8,i8*%bb,i64 24
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_50(i8*inreg%a,i8*inreg%b,i32 inreg%c)unnamed_addr#2 gc"smlsharp"{
p:
%d=alloca i8*,align 8
%e=alloca i8*,align 8
%f=alloca i8*,align 8
...
n:
%o=phi i8*[%m,%l],[%a,%p]
%q=call fastcc i8*@_SMLFN18UserLevelPrimitive33REIFY__exInfo__dynamicExistInstanceE(i8*inreg%o)
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_41 to void(...)*),void(...)**%E,align 8
%F=getelementptr inbounds i8,i8*%y,i64 16
%G=bitcast i8*%F to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_41 to void(...)*),void(...)**%G,align 8
...
%N=load i8*,i8**%d,align 8
store i8*null,i8**%d,align 8
%O=call fastcc i8*@_SMLFN18UserLevelPrimitive24REIFY__tyCon__existInstMapE(i8*inreg%N)
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_42 to void(...)*),void(...)**%aw,align 8
%ax=getelementptr inbounds i8,i8*%aq,i64 16
%ay=bitcast i8*%ax to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_42 to void(...)*),void(...)**%ay,align 8
%az=getelementptr inbounds i8,i8*%aq,i64 24
%aA=bitcast i8*%az to i32*
store i32 -2147483647,i32*%aA,align 4
%aB=load i8*,i8**%g,align 8
%aC=call fastcc i8*@_SMLFN11TypesBasics7derefTyE(i8*inreg%aB)
...
store i8*getelementptr inbounds(<{[4x i8],i32,[86x i8]}>,<{[4x i8],i32,[86x i8]}>*@a,i64 0,i32 2,i64 0),i8**%aQ,align 8
%aR=getelementptr inbounds i8,i8*%aK,i64 16
%aS=bitcast i8*%aR to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[7x i8]}>,<{[4x i8],i32,[7x i8]}>*@b,i64 0,i32 2,i64 0),i8**%aS,align 8
...
unreachable
a2:
%a3=getelementptr inbounds i8,i8*%aC,i64 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_45 to void(...)*),void(...)**%bs,align 8
%bt=getelementptr inbounds i8,i8*%bm,i64 16
%bu=bitcast i8*%bt to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_45 to void(...)*),void(...)**%bu,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_46 to void(...)*),void(...)**%bJ,align 8
%bK=getelementptr inbounds i8,i8*%bD,i64 16
%bL=bitcast i8*%bK to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_46 to void(...)*),void(...)**%bL,align 8
...
%bP=call fastcc i8*@_SMLFN11TypesBasics7derefTyE(i8*inreg%bO)
...
store i8*getelementptr inbounds(<{[4x i8],i32,[86x i8]}>,<{[4x i8],i32,[86x i8]}>*@a,i64 0,i32 2,i64 0),i8**%b3,align 8
%b4=getelementptr inbounds i8,i8*%bX,i64 16
%b5=bitcast i8*%b4 to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[7x i8]}>,<{[4x i8],i32,[7x i8]}>*@b,i64 0,i32 2,i64 0),i8**%b5,align 8
...
unreachable
cf:
%cg=getelementptr inbounds i8,i8*%bP,i64 8
...
%cA=getelementptr inbounds i8,i8*%cm,i64 32
%cB=bitcast i8*%cA to i32*
store i32%c,i32*%cB,align 4
%cC=getelementptr inbounds i8,i8*%cm,i64 40
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_49 to void(...)*),void(...)**%cK,align 8
%cL=getelementptr inbounds i8,i8*%cE,i64 16
%cM=bitcast i8*%cL to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_49 to void(...)*),void(...)**%cM,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_55(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
%f=alloca i8*,align 8
...
%B=call fastcc i8*%y(i8*inreg%A,i8*inreg%r)
...
%G=getelementptr inbounds i8,i8*%C,i64 24
%H=bitcast i8*%G to i8**
%I=load i8*,i8**%H,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_60(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
o:
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
store i8*null,i8**%c,align 8
%S=getelementptr inbounds i8,i8*%F,i64 24
%T=bitcast i8*%S to i8**
store i8*%R,i8**%T,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_62(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
%f=alloca i8*,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_67(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
o:
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_69(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
%f=alloca i8*,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_74(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
o:
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_75(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
p:
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
%S=call fastcc i8*@_SMLFN11RecordLabel10fromStringE(i8*inreg getelementptr inbounds(<{[4x i8],i32,[6x i8]}>,<{[4x i8],i32,[6x i8]}>*@g,i64 0,i32 2,i64 0))
...
%Y=call fastcc i32@_SMLFN9ExistTyID5toIntE(i32 inreg%R)
%Z=load i8*,i8**%e,align 8
%aa=load i8*,i8**%f,align 8
store i8*null,i8**%e,align 8
store i8*null,i8**%f,align 8
%ab=call fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_50(i8*inreg%Z,i8*inreg%aa,i32 inreg%Y)
%ac=bitcast i8*%ab to i8**
...
store i8*getelementptr inbounds(<{[4x i8],i32,[87x i8]}>,<{[4x i8],i32,[87x i8]}>*@i,i64 0,i32 2,i64 0),i8**%av,align 8
%aw=getelementptr inbounds i8,i8*%ap,i64 16
%ax=bitcast i8*%aw to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[9x i8]}>,<{[4x i8],i32,[9x i8]}>*@j,i64 0,i32 2,i64 0),i8**%ax,align 8
...
%aL=call fastcc i8*@_SMLFN11RecordLabel3Map4findE(i32 inreg 1,i32 inreg 8)
...
store i8*getelementptr inbounds(<{[4x i8],i32,[87x i8]}>,<{[4x i8],i32,[87x i8]}>*@h,i64 0,i32 2,i64 0),i8**%bc,align 8
%bd=getelementptr inbounds i8,i8*%a6,i64 16
%be=bitcast i8*%bd to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[9x i8]}>,<{[4x i8],i32,[9x i8]}>*@j,i64 0,i32 2,i64 0),i8**%be,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_69 to void(...)*),void(...)**%bN,align 8
%bO=getelementptr inbounds i8,i8*%bH,i64 16
%bP=bitcast i8*%bO to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_69 to void(...)*),void(...)**%bP,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_74 to void(...)*),void(...)**%cl,align 8
%cm=getelementptr inbounds i8,i8*%cf,i64 16
%cn=bitcast i8*%cm to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_74 to void(...)*),void(...)**%cn,align 8
...
%dl=call fastcc i8*@_SMLFN11RecordLabel10fromStringE(i8*inreg getelementptr inbounds(<{[4x i8],i32,[5x i8]}>,<{[4x i8],i32,[5x i8]}>*@f,i64 0,i32 2,i64 0))
store i8*%dl,i8**%d,align 8
%dm=bitcast i8**%h to i8***
%dn=load i8**,i8***%dm,align 8
%do=load i8*,i8**%dn,align 8
store i8*%do,i8**%e,align 8
%dp=getelementptr inbounds i8*,i8**%dn,i64 1
%dq=load i8*,i8**%dp,align 8
store i8*%dq,i8**%f,align 8
%dr=call fastcc i32@_SMLFN9ExistTyID5toIntE(i32 inreg%dk)
%ds=load i8*,i8**%e,align 8
%dt=load i8*,i8**%f,align 8
store i8*null,i8**%e,align 8
store i8*null,i8**%f,align 8
%du=call fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_50(i8*inreg%ds,i8*inreg%dt,i32 inreg%dr)
...
%dA=call fastcc i8*@_SMLFN11TypesBasics7derefTyE(i8*inreg%dz)
%dB=icmp eq i8*%dA,null
br i1%dB,label%dG,label%dC
dC:
%dD=bitcast i8*%dA to i32*
%dE=load i32,i32*%dD,align 4
%dF=icmp eq i32%dE,8
br i1%dF,label%d0,label%dG
dG:
store i8*null,i8**%d,align 8
store i8*null,i8**%e,align 8
store i8*null,i8**%f,align 8
store i8*null,i8**%h,align 8
%dH=load i8*,i8**@_SMLZN3Bug3BugE,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[87x i8]}>,<{[4x i8],i32,[87x i8]}>*@i,i64 0,i32 2,i64 0),i8**%dO,align 8
%dP=getelementptr inbounds i8,i8*%dI,i64 16
%dQ=bitcast i8*%dP to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[9x i8]}>,<{[4x i8],i32,[9x i8]}>*@j,i64 0,i32 2,i64 0),i8**%dQ,align 8
...
unreachable
d0:
%d1=getelementptr inbounds i8,i8*%dA,i64 8
%d2=bitcast i8*%d1 to i8**
%d3=load i8*,i8**%d2,align 8
store i8*%d3,i8**%g,align 8
%d4=call fastcc i8*@_SMLFN11RecordLabel3Map4findE(i32 inreg 1,i32 inreg 8)
...
store i8*null,i8**%i,align 8
%el=call fastcc i8*%d7(i8*inreg%ek,i8*inreg%ea)
%em=icmp eq i8*%el,null
br i1%em,label%en,label%eH
en:
store i8*null,i8**%d,align 8
store i8*null,i8**%e,align 8
store i8*null,i8**%f,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[87x i8]}>,<{[4x i8],i32,[87x i8]}>*@h,i64 0,i32 2,i64 0),i8**%ev,align 8
%ew=getelementptr inbounds i8,i8*%ep,i64 16
%ex=bitcast i8*%ew to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[9x i8]}>,<{[4x i8],i32,[9x i8]}>*@j,i64 0,i32 2,i64 0),i8**%ex,align 8
...
%eY=getelementptr inbounds i8,i8*%eK,i64 32
%eZ=bitcast i8*%eY to i32*
store i32 15,i32*%eZ,align 4
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_62 to void(...)*),void(...)**%e6,align 8
%e7=getelementptr inbounds i8,i8*%e0,i64 16
%e8=bitcast i8*%e7 to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_62 to void(...)*),void(...)**%e8,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_67 to void(...)*),void(...)**%fE,align 8
%fF=getelementptr inbounds i8,i8*%fy,i64 16
%fG=bitcast i8*%fF to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_67 to void(...)*),void(...)**%fG,align 8
...
%fP=load i8**,i8***%dm,align 8
%fQ=load i8*,i8**%fP,align 8
%fR=call fastcc i8*%fM(i8*inreg%fO,i8*inreg%fQ)
store i8*%fR,i8**%d,align 8
%fS=load i8**,i8***%dm,align 8
store i8*null,i8**%h,align 8
%fT=load i8*,i8**%fS,align 8
store i8*%fT,i8**%f,align 8
%fU=call i8*@sml_alloc(i32 inreg 44)#0
%fV=getelementptr inbounds i8,i8*%fU,i64 -4
%fW=bitcast i8*%fV to i32*
store i32 1342177320,i32*%fW,align 4
...
ret i8*%ge
gp:
%gq=getelementptr inbounds i8,i8*%z,i64 8
%gr=bitcast i8*%gq to i8**
%gs=load i8*,i8**%gr,align 8
%gt=icmp eq i8*%gs,null
br i1%gt,label%gy,label%gu
gu:
%gv=bitcast i8*%gs to i32*
%gw=load i32,i32*%gv,align 4
%gx=icmp eq i32%gw,5
br i1%gx,label%gz,label%gy
gy:
store i8*null,i8**%h,align 8
br label%jI
gz:
%gA=getelementptr inbounds i8,i8*%gs,i64 8
%gB=bitcast i8*%gA to i32**
%gC=load i32*,i32**%gB,align 8
%gD=load i32,i32*%gC,align 4
%gE=call fastcc i8*@_SMLFN11RecordLabel10fromStringE(i8*inreg getelementptr inbounds(<{[4x i8],i32,[4x i8]}>,<{[4x i8],i32,[4x i8]}>*@e,i64 0,i32 2,i64 0))
store i8*%gE,i8**%d,align 8
%gF=bitcast i8**%h to i8***
%gG=load i8**,i8***%gF,align 8
%gH=load i8*,i8**%gG,align 8
store i8*%gH,i8**%e,align 8
%gI=getelementptr inbounds i8*,i8**%gG,i64 1
%gJ=load i8*,i8**%gI,align 8
store i8*%gJ,i8**%f,align 8
%gK=call fastcc i32@_SMLFN9ExistTyID5toIntE(i32 inreg%gD)
%gL=load i8*,i8**%e,align 8
%gM=load i8*,i8**%f,align 8
store i8*null,i8**%e,align 8
store i8*null,i8**%f,align 8
%gN=call fastcc i8*@_SMLLLN20DynamicExistInstance20dynamicExistInstanceE_50(i8*inreg%gL,i8*inreg%gM,i32 inreg%gK)
...
%gT=call fastcc i8*@_SMLFN11TypesBasics7derefTyE(i8*inreg%gS)
%gU=icmp eq i8*%gT,null
br i1%gU,label%gZ,label%gV
gV:
%gW=bitcast i8*%gT to i32*
%gX=load i32,i32*%gW,align 4
%gY=icmp eq i32%gX,8
br i1%gY,label%hj,label%gZ
gZ:
store i8*null,i8**%d,align 8
store i8*null,i8**%e,align 8
store i8*null,i8**%f,align 8
store i8*null,i8**%h,align 8
%g0=load i8*,i8**@_SMLZN3Bug3BugE,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[87x i8]}>,<{[4x i8],i32,[87x i8]}>*@i,i64 0,i32 2,i64 0),i8**%g7,align 8
%g8=getelementptr inbounds i8,i8*%g1,i64 16
%g9=bitcast i8*%g8 to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[9x i8]}>,<{[4x i8],i32,[9x i8]}>*@j,i64 0,i32 2,i64 0),i8**%g9,align 8
%ha=getelementptr inbounds i8,i8*%g1,i64 24
%hb=bitcast i8*%ha to i32*
store i32 7,i32*%hb,align 4
%hc=call i8*@sml_alloc(i32 inreg 60)#0
%hd=getelementptr inbounds i8,i8*%hc,i64 -4
%he=bitcast i8*%hd to i32*
store i32 1342177336,i32*%he,align 4
%hf=getelementptr inbounds i8,i8*%hc,i64 56
%hg=bitcast i8*%hf to i32*
store i32 1,i32*%hg,align 4
%hh=load i8*,i8**%d,align 8
%hi=bitcast i8*%hc to i8**
store i8*%hh,i8**%hi,align 8
call void@sml_raise(i8*inreg%hc)#1
unreachable
hj:
%hk=getelementptr inbounds i8,i8*%gT,i64 8
%hl=bitcast i8*%hk to i8**
%hm=load i8*,i8**%hl,align 8
store i8*%hm,i8**%g,align 8
%hn=call fastcc i8*@_SMLFN11RecordLabel3Map4findE(i32 inreg 1,i32 inreg 8)
...
store i8*null,i8**%i,align 8
%hE=call fastcc i8*%hq(i8*inreg%hD,i8*inreg%ht)
%hF=icmp eq i8*%hE,null
br i1%hF,label%hG,label%h0
hG:
store i8*null,i8**%d,align 8
store i8*null,i8**%e,align 8
store i8*null,i8**%f,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[87x i8]}>,<{[4x i8],i32,[87x i8]}>*@h,i64 0,i32 2,i64 0),i8**%hO,align 8
%hP=getelementptr inbounds i8,i8*%hI,i64 16
%hQ=bitcast i8*%hP to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[9x i8]}>,<{[4x i8],i32,[9x i8]}>*@j,i64 0,i32 2,i64 0),i8**%hQ,align 8
...
%ih=getelementptr inbounds i8,i8*%h3,i64 32
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_55 to void(...)*),void(...)**%ip,align 8
%iq=getelementptr inbounds i8,i8*%ij,i64 16
%ir=bitcast i8*%iq to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_55 to void(...)*),void(...)**%ir,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_60 to void(...)*),void(...)**%iX,align 8
%iY=getelementptr inbounds i8,i8*%iR,i64 16
%iZ=bitcast i8*%iY to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_60 to void(...)*),void(...)**%iZ,align 8
...
%i8=load i8**,i8***%gF,align 8
%i9=load i8*,i8**%i8,align 8
%ja=call fastcc i8*%i5(i8*inreg%i7,i8*inreg%i9)
store i8*%ja,i8**%d,align 8
%jb=load i8**,i8***%gF,align 8
store i8*null,i8**%h,align 8
%jc=load i8*,i8**%jb,align 8
store i8*%jc,i8**%f,align 8
%jd=call i8*@sml_alloc(i32 inreg 44)#0
%je=getelementptr inbounds i8,i8*%jd,i64 -4
%jf=bitcast i8*%je to i32*
store i32 1342177320,i32*%jf,align 4
...
ret i8*%jx
jI:
%jJ=load i8*,i8**@_SMLZN3Bug3BugE,align 8
...
store i8*getelementptr inbounds(<{[4x i8],i32,[87x i8]}>,<{[4x i8],i32,[87x i8]}>*@c,i64 0,i32 2,i64 0),i8**%jQ,align 8
%jR=getelementptr inbounds i8,i8*%jK,i64 16
%jS=bitcast i8*%jR to i8**
store i8*getelementptr inbounds(<{[4x i8],i32,[39x i8]}>,<{[4x i8],i32,[39x i8]}>*@d,i64 0,i32 2,i64 0),i8**%jS,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_76(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
%f=alloca i8*,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_75 to void(...)*),void(...)**%M,align 8
%N=getelementptr inbounds i8,i8*%G,i64 16
%O=bitcast i8*%N to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_75 to void(...)*),void(...)**%O,align 8
...
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_77(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
call void@llvm.gcroot(i8**%c,i8*null)#0
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_76 to void(...)*),void(...)**%x,align 8
%y=getelementptr inbounds i8,i8*%r,i64 16
%z=bitcast i8*%y to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_76 to void(...)*),void(...)**%z,align 8
%A=getelementptr inbounds i8,i8*%r,i64 24
%B=bitcast i8*%A to i32*
store i32 -2147483647,i32*%B,align 4
ret i8*%r
}
define fastcc i8*@_SMLFN20DynamicExistInstance17generateExtraArgsE(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
...
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_77 to void(...)*),void(...)**%q,align 8
%r=getelementptr inbounds i8,i8*%k,i64 16
%s=bitcast i8*%r to void(...)**
store void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_77 to void(...)*),void(...)**%s,align 8
%t=getelementptr inbounds i8,i8*%k,i64 24
%u=bitcast i8*%t to i32*
store i32 -2147483647,i32*%u,align 4
ret i8*%k
}
define internal fastcc i8*@_SMLLLN20DynamicExistInstance17generateExtraArgsE_81(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN20DynamicExistInstance17generateExtraArgsE(i8*inreg%b)
ret i8*%c
}
