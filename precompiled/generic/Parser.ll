...
@a=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLLN6Parser5parseE_35 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN6Parser5parseE_50 to void(...)*),i32 -2147483647}>,align 8
@b=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLFN6Parser5parseE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN6Parser5parseE_51 to void(...)*),i32 -2147483647}>,align 8
...
@f=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i8*(i8*)*@_SMLLLN6Parser5isEOFE_42 to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN6Parser5isEOFE_52 to void(...)*),i32 -2147483647}>,align 8
@g=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i32(i8*)*@_SMLFN6Parser5isEOFE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN6Parser5isEOFE_53 to void(...)*),i32 -2147483647}>,align 8
@h=private unnamed_addr constant<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}><{[4x i8]zeroinitializer,i32 -805306344,i8*null,void(...)*bitcast(i32(i8*)*@_SMLFN6Parser13isInteractiveE to void(...)*),void(...)*bitcast(i8*(i8*,i8*)*@_SMLLLN6Parser13isInteractiveE_54 to void(...)*),i32 -2147483647}>,align 8
...
@_SMLZN6Parser13isInteractiveE=local_unnamed_addr constant i8*bitcast(i8**getelementptr inbounds(<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>,<{[4x i8],i32,i8*,void(...)*,void(...)*,i32}>*@h,i64 0,i32 2)to i8*)
@_SML_gvar968c9f4aee12cc9e_Parser=private global<{[4x i8],i32,[2x i8*]}><{[4x i8]zeroinitializer,i32 -1342177264,[2x i8*]zeroinitializer}>,align 8
@i=private unnamed_addr global[2x i64][i64 1,i64 sub(i64 ptrtoint(i8**getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i32 0,i32 2,i32 0)to i64),i64 ptrtoint([2x i64]*@i to i64))]
@_SML_ftab968c9f4aee12cc9e_Parser=external global i8
@j=private unnamed_addr global i8 0
@_SMLZN6Parser5setupE=alias i8*,getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i32 0,i32 2,i32 0)
@_SMLZN6Parser13sourceOfInputE=alias i8*,getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i32 0,i32 2,i32 1)
...
declare i8*@_SMLFN14SMLSharpParser13sourceOfInputE(i8*inreg)local_unnamed_addr#2 gc"smlsharp"
...
declare void@_SML_main60dca144d141c366_SMLSharpParser()local_unnamed_addr#2 gc"smlsharp"
...
declare void@_SML_load60dca144d141c366_SMLSharpParser(i8*)local_unnamed_addr
define private void@_SML_tabb968c9f4aee12cc9e_Parser()#3{
unreachable
}
define void@_SML_load968c9f4aee12cc9e_Parser(i8*%a)local_unnamed_addr#0{
...
tail call void@_SML_load60dca144d141c366_SMLSharpParser(i8*%a)#0
tail call void@sml_gcroot(i8*%a,void()*@_SML_tabb968c9f4aee12cc9e_Parser,i8*@_SML_ftab968c9f4aee12cc9e_Parser,i8*bitcast([2x i64]*@i to i8*))#0
ret void
}
define void@_SML_main968c9f4aee12cc9e_Parser()local_unnamed_addr#2 gc"smlsharp"{
...
tail call void@_SML_main60dca144d141c366_SMLSharpParser()#2
%g=bitcast[3x i8*]*%a to i8*
call void@sml_start(i8*inreg%g)#0
%h=load i8*,i8**@_SMLZN14SMLSharpParser5setupE,align 8
call void@sml_write(i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i64 0,i32 2,i64 0)to i8*),i8**inreg getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i64 0,i32 2,i64 0),i8*inreg%h)#0
%i=load i8*,i8**@_SMLZN14SMLSharpParser13sourceOfInputE,align 8
call void@sml_write(i8*inreg bitcast(i8**getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i64 0,i32 2,i64 0)to i8*),i8**inreg getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i64 0,i32 2,i64 1),i8*inreg%i)#0
call void@sml_end()#0
ret void
}
define internal fastcc i8*@_SMLLLN6Parser5parseE_35(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
define internal fastcc i8*@_SMLLLN6Parser5isEOFE_42(i8*inreg%a)#4 gc"smlsharp"{
%b=alloca i8*,align 8
%c=alloca i8*,align 8
%d=alloca i8*,align 8
%e=alloca i8*,align 8
...
define fastcc i32@_SMLFN6Parser13isInteractiveE(i8*inreg%a)#2 gc"smlsharp"{
i:
%b=alloca i8*,align 8
call void@llvm.gcroot(i8**%b,i8*null)#0
store i8*%a,i8**%b,align 8
...
%h=phi i8*[%f,%e],[%a,%i]
store i8*null,i8**%b,align 8
%j=call fastcc i8*@_SMLFN14SMLSharpParser13sourceOfInputE(i8*inreg%h)
%k=icmp eq i8*%j,null
%l=zext i1%k to i32
ret i32%l
}
...
g:
%h=phi i8*[%f,%e],[%a,%i]
%j=load i8*,i8**getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i64 0,i32 2,i64 0),align 8
...
g:
%h=phi i8*[%f,%e],[%a,%i]
%j=load i8*,i8**getelementptr inbounds(<{[4x i8],i32,[2x i8*]}>,<{[4x i8],i32,[2x i8*]}>*@_SML_gvar968c9f4aee12cc9e_Parser,i64 0,i32 2,i64 1),align 8
%k=getelementptr inbounds i8,i8*%j,i64 16
%l=bitcast i8*%k to i8*(i8*,i8*)**
%m=load i8*(i8*,i8*)*,i8*(i8*,i8*)**%l,align 8
%n=bitcast i8*%j to i8**
...
define internal fastcc i8*@_SMLLLN6Parser5parseE_50(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLLN6Parser5parseE_35(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN6Parser5parseE_51(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLFN6Parser5parseE(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN6Parser5isEOFE_52(i8*inreg%a,i8*inreg%b)#4 gc"smlsharp"{
%c=tail call fastcc i8*@_SMLLLN6Parser5isEOFE_42(i8*inreg%b)
ret i8*%c
}
define internal fastcc i8*@_SMLLLN6Parser5isEOFE_53(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
...
define internal fastcc i8*@_SMLLLN6Parser13isInteractiveE_54(i8*inreg%a,i8*inreg%b)#2 gc"smlsharp"{
%c=tail call fastcc i32@_SMLFN6Parser13isInteractiveE(i8*inreg%b)
%d=tail call i8*@sml_alloc(i32 inreg 4)#0
%e=bitcast i8*%d to i32*
%f=getelementptr inbounds i8,i8*%d,i64 -4
%g=bitcast i8*%f to i32*
