...
struct
  ...
  fun getOpt001 () =
      let
        ...
        val _ = assertEqualInt 2 getOpt1

        val getOpt2 = Option.getOpt (Option.SOME 1, 3)
        val _ = assertEqualInt 1 getOpt2
      in
        ()
      end
  ...
  fun isSome001 () =
      let
        ...
        val _ = assertFalse isSome1

        val isSome2 = Option.isSome (Option.SOME 1)
        val _ = assertTrue isSome2
      in
        ()
      end
  ...
  fun valOf001 () =
      let
        ...
        val _ = assertEqualInt 9 valOf1

        val valOf2 = Option.valOf (Option.SOME 2)
        val _ = assertEqualInt 2 valOf2
      in
        ()
      end
  ...
  fun filter001 () =
      let
        ...
        val _ = assertEqualIntOption (SOME 1) filter1

        val filter2 = Option.filter filterFun 2
        val _ = assertEqualIntOption NONE filter2
      in
        ()
      end
  end
  ...
  fun join001 () =
      let
        ...
        val _ = assertEqualIntOption NONE join1

        val join2 = Option.join (Option.SOME (Option.NONE))
        val _ = assertEqualIntOption NONE join2

        val join3 = Option.join (Option.SOME (Option.SOME 1))
        val _ = assertEqualIntOption (SOME 1) join3
      in
        ()
      end
  ...
  fun map001 () =
      let
        ...
        val _ = assertEqualIntOption NONE map1

        val map2 = Option.map mapFun (Option.SOME 1)
        val _ = assertEqualIntOption (SOME 2) map2
      in
        ()
      end
  end
  ...
  in
    fun mapPartial001 () =
        let
          ...
          val _ = assertEqualIntOption NONE mapPartial1

          val mapPartial2 = Option.mapPartial mapPartialFun (Option.SOME true)
          val _ = assertEqualIntOption (SOME 1) mapPartial2

          val mapPartial3 = Option.mapPartial mapPartialFun (Option.SOME false)
          val _ = assertEqualIntOption NONE mapPartial3
        in
          ()
        end
  end
  ...
  fun compose001 () =
      let
        ...
        val _ = assertEqualIntOption (SOME 10) compose1

        val compose2 = Option.compose (composeFun1, composeFun2) false
        val _ = assertEqualIntOption NONE compose2
      in
        ()
      end
  end
  ...
  fun composePartial001 () =
      let
        ...
        val _ = assertEqualIntOption NONE composePartial1

        val composePartial2 =
            Option.composePartial (composePartialFun1, composePartialFun2) 0
        val _ = assertEqualIntOption (SOME 9) composePartial2

        val composePartial3 =
            Option.composePartial (composePartialFun1, composePartialFun2) 1
        val _ = assertEqualIntOption NONE composePartial3
      in
        ()
      end
  end
