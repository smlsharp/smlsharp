...
/******** ADDED FOR SMLSHARP BEGIN ********/
/* here is the only difference from the original version. */
#define dtoa sml_dtoa
#define freedtoa sml_freedtoa
#define strtod sml_strtod
#define gethex sml_gethex
/******** ADDED FOR SMLSHARP END   ********/
