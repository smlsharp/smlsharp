...
struct
  local
    ...
    val REIFY_FUNMty_conInfo = ref NONE : T.conInfo option ref
    ...
    val REIFY_makeFUNMty_exInfo = ref NONE : I.exInfo option ref 
...
*)
 ...
 (* PolyDynamic data *)
  ...
  in
    ...
    (initExternalDecls ();
     ...
     REIFY_FUNMty_conInfo := findCon env                           ["ReifiedTy", "FUNMty"];
     ...
     REIFY_makeFUNMty_exInfo := findVar env                         ["ReifiedTy", "makeFUNMty"];
 ...
 (* JSON data *)
    ...
    val REIFY_FUNMty_conInfo = fn () => get "REIFY_FUNMty_conInfo" REIFY_FUNMty_conInfo
    ...
    val REIFY_makeFUNMty_exInfo = fn () => getVarInfo "REIFY_makeFUNMty_exInfo" REIFY_makeFUNMty_exInfo
