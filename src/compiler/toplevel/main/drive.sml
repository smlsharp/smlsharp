 ...
 * @version $Id: drive.sml,v 1.5 2006/02/18 04:59:30 ohori Exp $
 *)
structure Top =
struct
  ...
  type context =
	 ...
	 moduleEnvRef : ModuleCompiler.moduleEnv ref,
         ...
         topTypeContextRef : topTypeContext ref
       }
  ...
  (***************************************************************************)
  (* ToDo : provide some way for user to set these switches. *)

  (** true if trace of compilation should be printed. *)
  val switchTrace = ref true
      ...
      in
        {
          ...
          topTypeContextRef =
          (ref InitialTypeContext.initialTopTypeContext) : topTypeContext ref,
	 ...
	 moduleEnvRef
      ...
      let 
        ...
        fun compile (fixEnv, topTypeContext, moduleEnv, decs) =
            let
              val _ =
                  if !C.printSource andalso !switchTrace then
                    (
              ...
              val _ =
                  if !C.printPL andalso !switchTrace
                  then
                    (
                      printError "\nElaborated to:\n";
                      app
             ...
             (* Uncurrying  optimization *)
              ...
              val pldecs = UncurryFundecl.optimize pldecs
              val _ = #stop UncurryOptimizationTimeCounter ()
              val _ =
                  if !C.printUC andalso !switchTrace
                  then
                    (
                      printError "\nUncurry optimize to:\n";
                      app
              ...
              val _ = printWarnings warnings
              val _ =
                  if !C.printTP andalso !switchTrace
                  then
                    (
	      ...
	      (* module compile *)
              ...
              val _ = printWarnings warnings
              val _ =
                  if !C.printRC andalso !switchTrace
                  then
                    (
                      printError "\nMatch Compiled to:\n";
                      app
              ...
              val _ =
                  if !C.printTL andalso !switchTrace
                  then
                    (
                      printError "\nRecord Compiled to:\n";
                      app
              ...
              val _ =
                  ...
                  then
                    let
                      val diagnoses =  TypeCheckTypedLambda.typechekTypedLambda optimizedTldecs;
              ...
              val _ =
                  if !C.printBUC andalso !switchTrace
                  then
                    (
                      printError "\nBUC transform to:\n";
                      app
              ...
              val _ =
                  if !C.printAN andalso !switchTrace
                  then
                    (
              ...
              val _ =
                  if !C.printLS andalso !switchTrace
                  then
                    (
                      printError "\nLinearized to:\n";
                      app
...
(*
              ...
              val symbolicCode as {functions, ...} =
                  {
                    ...
                    functions =
                    if !C.doConstantPropagation
                    then
                      map
                          ConstantPropagation.optimize
                          (#functions symbolicCode)
                    else #functions symbolicCode
                  }
              ...
              val _ =
                  ...
                  then
                    (
                      printError "\nConstant Propagation Optimized to:\n";
                      app
                      (printError
                       o (fn string => string ^ "\n")
                       o SymbolicInstructionsFormatter.functionCodeToString)
...
*)
              ...
              val _ =
                  if !C.printIS andalso !switchTrace
                  then
                    (
                      printError "\nAssembled to:\n";
                      app
		...
		ModuleCompiler.updateModuleEnv
                    {newModuleEnv=newModuleEnv, oldModuleEnv =moduleEnv},
                codeBlock
              )
            end
