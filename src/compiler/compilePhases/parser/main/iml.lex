...
fun initArg {sourceName, enableMeta, lexErrorFn, initialLineno, allow8bitId} : arg =
    let
...
<INITIAL>"_NULL" => (T.UNULL (left(yypos,arg),right(yypos,5,arg)));
...
<INITIAL>"_foreach" => (T.FOREACH (left(yypos,arg),right(yypos,8,arg)));
...
<INITIAL>"_typeof" => (T.TYPEOF (left(yypos,arg),right(yypos,7,arg)));
...
<INITIAL>"exists" => (T.EXISTS (left(yypos,arg),right(yypos,6,arg)));
<INITIAL>"false" => (T.FALSE (left(yypos,arg),right(yypos,5,arg)));
<INITIAL>"fetch" => (T.FETCH (left(yypos,arg),right(yypos,5,arg)));
<INITIAL>"first" => (T.FIRST (left(yypos,arg),right(yypos,5,arg)));
...
<INITIAL>"group" => (T.GROUP (left(yypos,arg),right(yypos,5,arg)));
<INITIAL>"handle" => (T.HANDLE (left(yypos,arg),right(yypos,6,arg)));
<INITIAL>"having" => (T.HAVING (left(yypos,arg),right(yypos,6,arg)));
...
<INITIAL>"row" => (T.ROW (left(yypos,arg),right(yypos,3,arg)));
<INITIAL>"rows" => (T.ROWS (left(yypos,arg),right(yypos,4,arg)));
...
<INITIAL>"_sizeof" => (T.SIZEOF (left(yypos,arg),right(yypos,7,arg)));
<INITIAL>"_typeof" => (T.TYPEOF (left(yypos,arg),right(yypos,7,arg)));
<INITIAL>"_reifyTy" => (T.REIFYTY (left(yypos,arg),right(yypos,8,arg)));
...
<INITIAL>"true" => (T.TRUE (left(yypos,arg),right(yypos,4,arg)));
<INITIAL>"type" => (T.TYPE (left(yypos,arg),right(yypos,4,arg)));
<INITIAL>"unknown" => (T.UNKNOWN (left(yypos,arg),right(yypos,7,arg)));
<INITIAL>"update" => (T.UPDATE (left(yypos,arg),right(yypos,6,arg)));
<INITIAL>"use" => (if enableMeta then T.USE (left(yypos,arg),right(yypos,3,arg)) else T.ALPHABETICID (yytext,left(yypos,arg),right(yypos,3,arg)));
