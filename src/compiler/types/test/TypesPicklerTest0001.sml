 ...
 * @version $Id: TypesPicklerTest0001.sml,v 1.2 2006/02/20 06:52:03 kiyoshiy Exp $
 *)
...
*)
  ...
  fun testBITMAPty0001 () = testTy (T.BITMAPty [T.ATOMty])

  fun testFRAMEBITMAPty0001 () = testTy (T.FRAMEBITMAPty [0, 1])

  fun testBITty0001 () = testTy (T.BITty 10)

  fun testBMABSty0001 () = testTy (T.BMABSty ([T.ATOMty], T.BOXEDty))
  ...
  fun testDBLUNBOXEDty0001 () = testTy T.DBLUNBOXEDty
  ...
  fun testINDEXty0001 () = testTy (T.INDEXty (T.ATOMty, "a"))

  fun testOFFSETty0001 () = testTy (T.OFFSETty [T.ATOMty])

  fun testPADCONDty0001 () = testTy (T.PADCONDty ([T.ATOMty], 1))

  fun testPADty0001 () = testTy (T.PADty [T.ATOMty])
  ...
  fun testSIZEty0001 () = testTy (T.SIZEty 10)
      
  fun testSPECty0001 () = testTy (T.SPECty T.ATOMty)

  fun testTAGty0001 () = testTy (T.TAGty 123)
  ...
  fun testUNBOXEDty0001 () = testTy T.UNBOXEDty
  ...
  fun suite () =
      ...
      [
        ...
        ("testBITMAPty0001", testBITMAPty0001),
        ("testFRAMEBITMAPty0001", testFRAMEBITMAPty0001),
        ("testBITty0001", testBITty0001),
        ("testBMABSty0001", testBMABSty0001),
        ("testBOUNDVARty0001", testBOUNDVARty0001),
        ("testBOXEDty0001", testBOXEDty0001),
        ("testCONty0001", testCONty0001),
        ("testDBLUNBOXEDty0001", testDBLUNBOXEDty0001),
        ...
        ("testINDEXty0001", testINDEXty0001),
        ("testOFFSETty0001", testOFFSETty0001),
        ("testPADCONDty0001", testPADCONDty0001),
        ("testPADty0001", testPADty0001),
        ("testPOLYty0001", testPOLYty0001),
        ("testRECORDty0001", testRECORDty0001),
        ("testSIZEty0001", testSIZEty0001),
        ("testSPECty0001", testSPECty0001),
        ("testTAGty0001", testTAGty0001),
        ("testTYVARty0001", testTYVARty0001),
        ("testUNBOXEDty0001", testUNBOXEDty0001),
