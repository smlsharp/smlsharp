...
struct
  type ord_key = {path:SymbolWithLoc.longsymbol, id:VarID.id, ty:Types.ty, opaque:bool}
  fun compare ({path = _, ty = _, opaque = _, id = varId1} : ord_key,
	       {path = _, ty = _, opaque = _, id = varId2} : ord_key) =
