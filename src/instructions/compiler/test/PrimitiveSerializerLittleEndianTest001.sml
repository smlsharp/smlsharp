 ...
 * @version $Id: PrimitiveSerializerLittleEndianTest001.sml,v 1.1 2005/12/31 10:22:01 kiyoshiy Exp $
 *)
structure PrimitiveSerializerLittleEndianTest001 =
struct
  ...
  structure Testee = PrimitiveSerializerLittleEndian

  (***************************************************************************)

  fun testByteOrder0001 () =
      if Testee.byteOrder = SystemDefTypes.LittleEndian
      then ()
  ...
  val TESTWRITELOWBYTES0003_EXPECTED =
      [0wx78, 0wx56, 0wx34] : Word8.word list
  ...
  val TESTWRITELOWBYTES0004_EXPECTED =
      [0wx78, 0wx56, 0wx34, 0wx12] : Word8.word list
  ...
  val TESTREADBYTES0002_EXPECTED = 0wx3412 : Word32.word
  ...
  val TESTREADBYTES0003_EXPECTED = 0wx563412 : Word32.word
  ...
  val TESTREADBYTES0004_EXPECTED = 0wx78563412 : Word32.word
