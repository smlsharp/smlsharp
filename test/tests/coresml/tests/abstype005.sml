(*
name resolution within a abstype declaration with "withtype".
...
<ul>
  ...
  <li>name bound in withtype is used in abstype.
    <ul>
      <li>no</li>
      <li>yes</li>
    </ul>
  </li>
  <li>name bound in abstype is used in withtype.
    <ul>
      <li>no</li>
      <li>yes</li>
    </ul>
...
*)
abstype dt11nn1 = D11nn1 withtype t11nn1 = int
with
val dt11nn1 = D11nn1
val t11nn1 = 1 : t11nn1
end;

abstype dt11ny1 = D11ny1 withtype t11ny1 = int * dt11ny1
with
val dt11ny1 = D11ny1
val t11ny1 = (1, D11ny1) : t11ny1
end;

abstype dt11yn1 = D11yn1 of t11yn1 withtype t11yn1 = int
with
val dt11yn1 = D11yn1 1
val t11yn1 = 1 : t11yn1
end;

abstype dt11yy1 = D11yy1 of t11yy1 | E11yy1 withtype t11yy1 = dt11yy1 * int
with
val dt11yy1 = D11yy1(E11yy1, 1)
val t11yy1 = (E11yy1, 1) : t11yy1
end;

abstype dt22nn1 = D22nn1 and dt22nn2 = D22nn2 
...
abstype dt22ny1 = D22ny1 and dt22ny2 = D22ny2 
...
abstype dt22yn1 = D22yn1 of t22yn2 * int and dt22yn2 = D22yn2 of t22yn1 * int
...
abstype dt22yy1 = D22yy1 of t22yy2 * int | E22yy1
