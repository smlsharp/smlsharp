(*
same type variables occur in multiple datatype bindings in datatype declaration.
rule 17, 28
...
<ul>
  ...
  <li>the number of datatype bindings
    <ul>
      <li>2</li>
    </ul>
  </li>
 ...
 *)
datatype 'x1 t121 = C121 of 'x1 * int and 'x1 t122 = C122 of int * 'x1;
val v12 : (bool t121 * real t122) = (C121(true, 121), C122(122, 1.22));

datatype ('x1, 'x2) t221 = C221 of 'x1 * int * 'x2
