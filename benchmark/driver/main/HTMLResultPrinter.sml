 ...
 * @version $Id: HTMLResultPrinter.sml,v 1.10 2006/02/04 13:48:47 kiyoshiy Exp $
 *)
...
struct
  ...
  fun printCaseResultEntry
    ...
    in
      ...
      case #compileOutputArrayOpt result of
        NONE => print "&nbsp;"
      | SOME outputArray => 
        (print (Byte.unpackString (outputArray, 0, NONE)));
      print "</TD>";
  ...
  fun printOptions resultPageChannel =
      ...
      in
        ...
        app printRow (SEnv.listItemsi C.switchTable);
        print "</table>\n";
        print "</P>\n"
      end
