...
in  
  ...
  fun printTvar tvar =
      print (Control.prettyPrint (T.format_tvar tvar))
  fun printTvarId tvarId =
      print (Control.prettyPrint (T.format_tvarId tvarId))
  fun printVarId varId =
      print (Control.prettyPrint (T.format_varId varId))
  ...
  fun printTy ty =
      print (Control.prettyPrint (T.format_ty ty))
  fun printPITy ty =
  ...
  fun printConSpec conSpec =
      print (Control.prettyPrint (T.format_conSpec conSpec))
  fun printTfun tfun =
      print (Control.prettyPrint (T.format_tfun tfun))
  fun printTfunkind tfunkind =
      print (Control.prettyPrint (T.format_tfunkind tfunkind))
  fun printIdstatus idstatus =
      print (Control.prettyPrint (T.format_idstatus idstatus) ^ "\n")
  fun printTypId typId =
      print (Control.prettyPrint (T.format_typId typId))
  fun printConId conId =
      print (Control.prettyPrint (T.format_conId conId))
  ...
  fun printSubst {tvarS, tfvS, conIdS} =
      let
        val _ = print "tvarS\n"
        val _ =
            (print "[\n";
