...
*)
  ...
  fun selectAlloc allocFunc context code
      ...
      let
        ...
        val (code, bitmapOffset) =
            andInsn code (bitmapOffset, R.CONST (R.UINT32 (Word32.notb 0w3)))
        ...
        val (code, header) = orInsn code (header, bitmapOffset)
  ...
  fun selectInsn context code insn =
      ...
      | AI.Update {block, offset, ty, size, value, barrier, loc} =>
        let
          ...
          val (code, value) = transformValue context code value
          val size = transformOperand size
          val code = selectMove code (R.MEM (dstTy, R.ADDR addr), value,
                                      SOME size)
        in
          case barrier of
            AI.NoBarrier => code
          ...
          | AI.BarrierTag value =>
            let
              ...
              val code =
                  insertLastBefore
                    (code, fn l => R.CJUMP {test = R.TEST_AND (R.Int32 R.U,
                                                               value, value),
                                            cc = R.EQUAL,
                                            thenLabel = endLabel,
                                            elseLabel = l})
