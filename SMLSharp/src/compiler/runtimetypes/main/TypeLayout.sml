...
struct
  ...
  fun runtimeTyOfBuiltinTy ty =
      case ty of
        BuiltinType.INTty => R.INTty
      | BuiltinType.WORDty => R.UINTty
      | BuiltinType.WORD8ty => R.UCHARty
      | BuiltinType.CHARty => R.UCHARty
      | BuiltinType.STRINGty => R.BOXEDty
      | BuiltinType.REALty => R.DOUBLEty
      | BuiltinType.REAL32ty => R.FLOATty
      | BuiltinType.UNITty => R.UINTty
      | BuiltinType.PTRty => R.POINTERty
      | BuiltinType.ARRAYty => R.BOXEDty
      | BuiltinType.EXNty => R.BOXEDty
      | BuiltinType.INTINFty => R.BOXEDty
      | BuiltinType.BOXEDty => R.BOXEDty
      | BuiltinType.EXNTAGty => R.BOXEDty
      ...
      | AT.CONty {tyCon, args} =>
        (
          case #dtyKind tyCon of
            T.BUILTIN ty => SOME (runtimeTyOfBuiltinTy ty)
          ...
          | Types.DTY =>
            case DatatypeCompilation.representationOf tyCon of
              DatatypeCompilation.BOXEDty => SOME R.BOXEDty
            | DatatypeCompilation.WORDty => SOME R.UINTty
        )
      | AT.BOUNDVARty tid =>
