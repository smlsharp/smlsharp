...
struct
  ...
  fun conv p =
      ...
      | X(P Ptr_deref_int) => N 74 | N 74 => X(P Ptr_deref_int)
      | X(P Ptr_deref_real) => N 75 | N 75 => X(P Ptr_deref_real)
      | X(P Ptr_deref_float) => N 76 | N 76 => X(P Ptr_deref_float)
      | X(P Ptr_deref_word) => N 77 | N 77 => X(P Ptr_deref_word)
      | X(P Ptr_deref_char) => N 78 | N 78 => X(P Ptr_deref_char)
      | X(P Ptr_deref_byte) => N 79 | N 79 => X(P Ptr_deref_byte)
      | X(P Real_abs) => N 80 | N 80 => X(P Real_abs)
      | X(P Real_add) => N 81 | N 81 => X(P Real_add)
      | X(P Real_div) => N 82 | N 82 => X(P Real_div)
      | X(P Real_equal) => N 83 | N 83 => X(P Real_equal)
      | X(P Real_fromInt) => N 84 | N 84 => X(P Real_fromInt)
      | X(P Real_gt) => N 85 | N 85 => X(P Real_gt)
      | X(P Real_gteq) => N 86 | N 86 => X(P Real_gteq)
      | X(P Real_lt) => N 87 | N 87 => X(P Real_lt)
      | X(P Real_lteq) => N 88 | N 88 => X(P Real_lteq)
      | X(P Real_mul) => N 89 | N 89 => X(P Real_mul)
      | X(P Real_neg) => N 90 | N 90 => X(P Real_neg)
      | X(P Real_sub) => N 91 | N 91 => X(P Real_sub)
      | X(P (Real_trunc_unsafe v)) => O(92,v) | O(92,v) => X(P (Real_trunc_unsafe v))
      | X(P String_array) => N 93 | N 93 => X(P String_array)
      | X(P String_copy_unsafe) => N 94 | N 94 => X(P String_array)
      | X(P String_equal) => N 95 | N 95 => X(P String_equal)
      | X(P String_gt) => N 96 | N 96 => X(P String_gt)
      | X(P String_gteq) => N 97 | N 97 => X(P String_gteq)
      | X(P String_lt) => N 98 | N 98 => X(P String_lt)
      | X(P String_lteq) => N 99 | N 99 => X(P String_lteq)
      | X(P String_size) => N 100 | N 100 => X(P String_size)
      | X(P String_sub_unsafe) => N 101 | N 101 => X(P String_sub_unsafe)
      | X(P String_update_unsafe) => N 102 | N 102 => X(P String_update_unsafe)
      | X(P String_vector) => N 103 | N 103 => X(P String_vector)
      | X(P Word_add) => N 104 | N 104 => X(P Word_add)
      | X(P Word_andb) => N 105 | N 105 => X(P Word_andb)
      | X(P Word_arshift) => N 106 | N 106 => X(P Word_arshift)
      | X(P Word_div) => N 107 | N 107 => X(P Word_div)
      | X(P Word_equal) => N 108 | N 108 => X(P Word_equal)
      | X(P Word_fromInt) => N 109 | N 109 => X(P Word_fromInt)
      | X(P Word_gt) => N 110 | N 110 => X(P Word_gt)
      | X(P Word_gteq) => N 111 | N 111 => X(P Word_gteq)
      | X(P Word_lshift) => N 112 | N 112 => X(P Word_lshift)
      | X(P Word_lt) => N 113 | N 113 => X(P Word_lt)
      | X(P Word_lteq) => N 114 | N 114 => X(P Word_lteq)
      | X(P Word_mod) => N 115 | N 115 => X(P Word_mod)
      | X(P Word_mul) => N 116 | N 116 => X(P Word_mul)
      | X(P Word_notb) => N 117 | N 117 => X(P Word_notb)
      | X(P Word_orb) => N 118 | N 118 => X(P Word_orb)
      | X(P Word_rshift) => N 119 | N 119 => X(P Word_rshift)
      | X(P Word_sub) => N 120 | N 120 => X(P Word_sub)
      | X(P Word_toIntX) => N 121 | N 121 => X(P Word_toIntX)
      | X(P Word_xorb) => N 122 | N 122 => X(P Word_xorb)
      | X(S List_first) => N 123 | N 123 => X(S List_first)
      | X(S Array_first) => N 124 | N 124 => X(S Array_first)
      | X(S List_second) => N 125 | N 125 => X(S List_first)
      | X(S Array_second) => N 126 | N 126 => X(S Array_first)
      | X(S Int_first) => N 127 | N 127 => X(S Int_first)
      | X(S Real_second) => N 128 | N 128 => X(S Real_second)
