 ...
 * @version $Id: Heap.sml,v 1.26 2007/08/17 07:01:15 ohori Exp $
 *)
structure Heap :> HEAP =
struct
  ...
  val C.CounterSetInternal heapCounterSet =
      #addSet C.root ("Heap", C.ORDER_OF_ADDITION)
  val C.CounterSetInternal GCCounterSet =
      #addSet heapCounterSet ("GC", C.ORDER_OF_ADDITION)
  val GCCounter =
      #addAccumulation GCCounterSet "GC"
  val C.CounterSetInternal accessCounterSet =
