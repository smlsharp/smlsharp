 ...
 * @version $Id: DatePrimitives.sml,v 1.4 2007/08/17 07:01:15 ohori Exp $
 *)
...
struct
  ...
  fun Date_localTime VM heap [Int seconds] =
      let
        val localDate = Date.fromTimeLocal(Time.fromSeconds (SInt32.toLarge seconds))
  ...
  fun Date_gmTime VM heap [Int seconds] =
      let
        val univDate = Date.fromTimeUniv(Time.fromSeconds (SInt32.toLarge seconds))
