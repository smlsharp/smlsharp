 ...
 * @version $Id: StringPrimitives.sml,v 1.9 2007/09/20 09:02:54 matsu Exp $
 *)
            ...
            Word8ArraySlice.copy
                {
                  ...
                  src = Word8ArraySlice.slice (leftArray,0,SOME (UInt32ToInt leftLength)) (*,
                  si = 0*)
                }
        val _ =
            Word8ArraySlice.copy
                {
                  ...
                  src = Word8ArraySlice.slice (resultArray,0,SOME (UInt32ToInt rightLength))  (*,
                  si = 0*)
                }
        val resultBlock =
