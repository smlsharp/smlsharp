 ...
 * @version $Id: RuntimeTypes.sml,v 1.23 2007/11/01 08:11:59 kiyoshiy Exp $
 *)
...
*)
  ...
  fun cellValueToString (Int n) = "Int(" ^ (SInt32.toString n) ^ ")"
    ...
    | cellValueToString (Float f) = "Float(" ^ (Real32.toString f) ^ ")"
(*
...
*)
  ...
  fun floatOf message (Float real) = real
    | floatOf message cell =
      raise
        UnexpectedCellValue
            (message ^ 
             ":expected a float, but found " ^ cellValueToString cell)
