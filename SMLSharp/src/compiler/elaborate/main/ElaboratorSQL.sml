...
struct
  ...
  val SQLDBConName = ["_SQL", "DB"]
  val SQLDBIConName = ["_SQL", "DBI"]
  val SQLTableConName = ["_SQL", "TABLE"]
  val SQLRowConName = ["_SQL", "ROW"]
  val SQLValueConName = ["_SQL", "VALUE"]
  val SQLQueryConName = ["_SQL", "QUERY"]
  val SQLCommandConName = ["_SQL", "COMMAND"]
  val SQLResultConName = ["_SQL", "RESULT"]
  val boolTyName = ["_SQL", "bool"]
  val optionTyName = ["_SQL", "option"]
  val SQLValueTyName = ["_SQL", "value"]
  val concatDotFunName = ["_SQL", "concatDot"]
  val concatQueryFunName = ["_SQL", "concatQuery"]
  val execFunName = ["_SQL", "exec"]
  val evalFunName = ["_SQL", "eval"]
  val fromSQLFunName = ["_SQL_fromSQL"]
  val defaultFunName = ["_SQL_default"]
  ...
  fun intCon (n, loc) =
      P.PLCONSTANT (A.INT (BigInt.fromInt n, loc), loc)
  ...
  fun commandCon (queryStrings, loc) =
      appExp (SQLCommandConName,
              appExp (concatQueryFunName, P.PLLIST (queryStrings, loc), loc),
              loc)
  ...
  fun bindsToDecls (nil, loc) = nil
    | bindsToDecls (binds, loc) = [P.PDVAL (nil, binds, loc)]
        ...
        let
          ...
          val rowWitnessExps =
              map (fn row =>
                  ...
                  insertLists
          val witnessExp =
              P.PLLIST (tableWitnessExp :: rowWitnessExps, loc)
          val witnessBinds =
        ...
        let
          ...
          val strs =
              map (fn (l,v) =>
                  ...
                  strs
        in
          P.PLSQLSERVER (strs, elabTy schema, loc)
        end
