 ...
 * @version $Id: UseDef.sml,v 1.10 2007/10/29 10:12:56 kiyoshiy Exp $
 *)
...
fun def arg_map inst =
    let fun aux ins =  
            case ins of LoadInt {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | LoadLargeInt {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | LoadAddress {address, destination} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | AddLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | AddLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | AddFloat_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | AddFloat_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | SubLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | SubLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | SubFloat_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | SubFloat_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | MulLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | MulLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | MulFloat_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | MulFloat_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | DivLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | DivLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | DivFloat_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | DivFloat_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | ModLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | ModLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | QuotLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | QuotLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | RemLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | RemLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | LtLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | LtLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | LtFloat_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | LtFloat_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | GtLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | GtLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | GtFloat_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | GtFloat_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | LteqLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | LteqLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | LteqFloat_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | LteqFloat_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | GteqLargeInt_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | GteqLargeInt_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      ...
                      | GteqFloat_Const_1 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | GteqFloat_Const_2 {destination,...} => [valOf(AUX.VarMap.find (arg_map,destination))]
    ...
    let fun aux ins =  
            case ins of LoadInt _  => [] : int list
                      ...
                      | CopyArray {srcEntry,srcOffsetEntry,dstEntry,dstOffsetEntry,lengthEntry,elementSize} =>
                        map (findNumbers arg_map) ([srcEntry,srcOffsetEntry,dstEntry,dstOffsetEntry,lengthEntry] @ entryOfSize elementSize)
                      ...
                      | SwitchLargeInt {targetEntry,...} => [valOf(AUX.VarMap.find (arg_map,targetEntry))]
                      ...
                      | Jump _ => []
                      | IndirectJump {destination} => [valOf(AUX.VarMap.find (arg_map,destination))]
                      | Exit => []
                      | Return_0 => []
                      ...
                      | AddLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | AddLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | AddFloat_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | AddFloat_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | SubLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | SubLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | SubFloat_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | SubFloat_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | MulLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | MulLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | MulFloat_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | MulFloat_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | DivLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | DivLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | DivFloat_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | DivFloat_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | ModLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | ModLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | QuotLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | QuotLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | RemLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | RemLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | LtLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | LtLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | LtFloat_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | LtFloat_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | GtLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | GtLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | GtFloat_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | GtFloat_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | LteqLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | LteqLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | LteqFloat_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | LteqFloat_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | GteqLargeInt_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | GteqLargeInt_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
                      ...
                      | GteqFloat_Const_1 {argEntry2,...} => [valOf(AUX.VarMap.find (arg_map,argEntry2))]
                      | GteqFloat_Const_2 {argEntry1,...} => [valOf(AUX.VarMap.find (arg_map,argEntry1))]
