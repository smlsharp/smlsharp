 ...
 * @version $Id: InstructionSizeCalculator.sml,v 1.40 2007/12/19 02:00:56 kiyoshiy Exp $
 *)
...
struct
  ...
  fun wordsOfInstruction instruction =
      ...
      | SI.LoadLargeInt _ => 0w3 : BT.UInt32
      | SI.LoadWord _ => 0w3
      ...
      | SI.CopyArray {elementSize = SI.SINGLE,...} => 0w6
      | SI.CopyArray {elementSize = SI.DOUBLE,...} => 0w6
      | SI.CopyArray {elementSize = SI.VARIANT v,...} => 0w7
      ...
      | SI.MakeArray {initialValueSize = SI.SINGLE,...} => 0w6
      | SI.MakeArray {initialValueSize = SI.DOUBLE,...} => 0w6
      | SI.MakeArray {initialValueSize = SI.VARIANT v,...} => 0w7
      ...
      | SI.SwitchLargeInt {cases, ...} => 0w4 + ((length cases) * 0w2)
      ...
      | SI.AddLargeInt_Const_1 _ => 0w4
      | SI.AddLargeInt_Const_2 _ => 0w4
      | SI.AddReal_Const_1 _ => 0w5
      | SI.AddReal_Const_2 _ => 0w5
      | SI.AddFloat_Const_1 _ => 0w4
      | SI.AddFloat_Const_2 _ => 0w4
      ...
      | SI.SubLargeInt_Const_1 _ => 0w4
      | SI.SubLargeInt_Const_2 _ => 0w4
      | SI.SubReal_Const_1 _ => 0w5
      | SI.SubReal_Const_2 _ => 0w5
      | SI.SubFloat_Const_1 _ => 0w4
      | SI.SubFloat_Const_2 _ => 0w4
      ...
      | SI.MulLargeInt_Const_1 _ => 0w4
      | SI.MulLargeInt_Const_2 _ => 0w4
      | SI.MulReal_Const_1 _ => 0w5
      | SI.MulReal_Const_2 _ => 0w5
      | SI.MulFloat_Const_1 _ => 0w4
      | SI.MulFloat_Const_2 _ => 0w4
      ...
      | SI.DivLargeInt_Const_1 _ => 0w4
      | SI.DivLargeInt_Const_2 _ => 0w4
      | SI.DivReal_Const_1 _ => 0w5
      | SI.DivReal_Const_2 _ => 0w5
      | SI.DivFloat_Const_1 _ => 0w4
      | SI.DivFloat_Const_2 _ => 0w4
      ...
      | SI.ModLargeInt_Const_1 _ => 0w4
      | SI.ModLargeInt_Const_2 _ => 0w4
      ...
      | SI.QuotLargeInt_Const_1 _ => 0w4
      | SI.QuotLargeInt_Const_2 _ => 0w4

      | SI.RemInt_Const_1 _ => 0w4
      | SI.RemInt_Const_2 _ => 0w4
      | SI.RemLargeInt_Const_1 _ => 0w4
      | SI.RemLargeInt_Const_2 _ => 0w4

      | SI.LtInt_Const_1 _ => 0w4
      | SI.LtInt_Const_2 _ => 0w4
      | SI.LtLargeInt_Const_1 _ => 0w4
      | SI.LtLargeInt_Const_2 _ => 0w4
      | SI.LtReal_Const_1 _ => 0w5
      | SI.LtReal_Const_2 _ => 0w5
      | SI.LtFloat_Const_1 _ => 0w4
      | SI.LtFloat_Const_2 _ => 0w4
      ...
      | SI.GtLargeInt_Const_1 _ => 0w4
      | SI.GtLargeInt_Const_2 _ => 0w4
      | SI.GtReal_Const_1 _ => 0w5
      | SI.GtReal_Const_2 _ => 0w5
      | SI.GtFloat_Const_1 _ => 0w4
      | SI.GtFloat_Const_2 _ => 0w4
      ...
      | SI.LteqLargeInt_Const_1 _ => 0w4
      | SI.LteqLargeInt_Const_2 _ => 0w4
      | SI.LteqReal_Const_1 _ => 0w5
      | SI.LteqReal_Const_2 _ => 0w5
      | SI.LteqFloat_Const_1 _ => 0w4
      | SI.LteqFloat_Const_2 _ => 0w4
      ...
      | SI.GteqLargeInt_Const_1 _ => 0w4
      | SI.GteqLargeInt_Const_2 _ => 0w4
      | SI.GteqReal_Const_1 _ => 0w5
      | SI.GteqReal_Const_2 _ => 0w5
      | SI.GteqFloat_Const_1 _ => 0w4
      | SI.GteqFloat_Const_2 _ => 0w4
