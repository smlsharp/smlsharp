 ...
 * @version $Id: TypedLambdaOptimizer.sml,v 1.16 2007/09/01 03:21:15 kiyoshiy Exp $
 *)
...
*)
  ...
  fun optimizeExp subst exp =
      ...
      | TLCOPYARRAY (e1, e2, e3, e4, e5, ty1, loc) =>
        TLCOPYARRAY
            (
              optimizeExp subst e1,
              optimizeExp subst e2,
              optimizeExp subst e3,
              optimizeExp subst e4,
              optimizeExp subst e5,
              ty1,
              loc
            )
