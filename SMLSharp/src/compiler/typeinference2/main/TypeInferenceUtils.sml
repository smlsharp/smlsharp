...
in
  ...
  and eqSMap btvEquiv (smap1, smap2) =
      let
        val tyL1 = SEnv.listItems smap1
        val tyL2 = SEnv.listItems smap2
      in
        ...
        | T.RECORDty tyFields => 
          (
           case fromTy of
             ...
             let
               val labels = SEnv.listKeys tyFields
               val fromLabels = SEnv.listKeys fromTyFields
                                   ...
                                   val litem =
                                       TPC.TPSELECT
                                         {label=label,
                                          ...
                                          loc=loc}
                                 in
                                   SEnv.insert(expFields,label,litem)
                                 end
                             )
                             SEnv.empty
                             fromTyFields
