...
sig
  ...
  (***************************************************************************)
  (**
   * compile given abstract syntax into code
   * @return code * updated basis * contextUpdater
   *)
  val phasesCompile : TopBasis.basis
                      -> Absyn.topdec list
                      -> SessionTypes.compileResult option * 
                         TopBasis.basis * 
                         (TopBasis.context -> TopBasis.context)

  (**
   * compile type instantiation code generated at require specification constraint
   *)
  val phasesFromUnCurryOptimizationCompile : TopBasis.basis
