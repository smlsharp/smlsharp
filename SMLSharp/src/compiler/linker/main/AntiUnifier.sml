 ...
 * @author Liu Bochao
 * @version $Id: AntiUnifier.sml,v 1.8 2007/09/10 14:13:30 kiyoshiy Exp $
 *)
...
struct
  local
      ...
      structure TypeEnv = BinaryMapMaker(TypeOrd)
  in
                      ...
                      val newTy2 = 
                          case newTy1 of
                            ...
                            | _ =>
                              raise 
                                Control.Bug 
                                "SPECTty should be CONty or TYVARty:(linker/main/AntiUnifier.sml)"
                  in
                      (newTy2, subst)
                  end
