...
structure BinarySearchCode : sig
  ...
  val generate
      : (
          ...
          * AbstractInstruction.label option   (* label of this node *)
          * AbstractInstruction.label option   (* left child label *)
          * AbstractInstruction.label option   (* right child label *)
          ->
