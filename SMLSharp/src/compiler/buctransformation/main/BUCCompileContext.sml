 ...
 * @version $Id: BUCCompileContext.sml,v 1.8 2007/09/10 14:13:30 kiyoshiy Exp $
 *)
...
structure BUCCompileContext :> BUCCOMPILECONTEXT = struct
  ...
  structure bookmark_ord:ORD_KEY = struct 
  ...
  structure Bookmark = BinaryMapMaker(bookmark_ord)
