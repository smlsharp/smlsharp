 ...
 * @version $Id: CConfig.sml,v 1.2 2008/12/10 08:59:19 katsu Exp $
 *)
...
struct
  ...
  fun rm_rf filename =
      if OS.FileSys.isDir filename
      then removeDir filename
      else rm_f filename

  and removeDir dirname =
      let
        fun loop dir =
