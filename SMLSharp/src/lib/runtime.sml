...
val GenericOS_tempFileName = _import "GenericOS_tempFileName" : unit -> string
...
val StandardC_errno = _import "StandardC_errno" : unit -> int
...
val Platform_getPlatform = _import "Platform_getPlatform" : unit -> string
val Platform_isBigEndian = _import "Platform_isBigEndian" : unit -> bool
...
val SMLSharpCommandLine_executableImageName = _import "SMLSharpCommandLine_executableImageName" : unit -> string option
