...
structure Rand : RAND =
  struct
    ...
    val extToInt = Int32.fromLarge o Word32.toLargeInt
    val intToExt = Word32.fromLargeInt o Int32.toLarge
    ...
    fun norm s = (Real.fromLargeInt (Word32.toLargeInt s)) / real_m
    ...
    fun range (i,j) = 
          if j < i 
            ...
            val cvt = Word32.toIntX o Word32.fromLargeInt o Int32.toLarge
            in
              if R = m then Word32.toIntX
