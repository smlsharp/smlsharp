(**
 * A multibyte string version of PARSER_COMB in SML/NJ library
 ...
 * </p>
 *)
signature MULTI_BYTE_PARSER_COMBINATOR =
  sig
    ...
    val skipBefore
        : (char -> bool) -> ('a, 'strm) parser -> ('a, 'strm) parser
