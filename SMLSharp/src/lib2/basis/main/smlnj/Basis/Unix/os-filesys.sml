...
struct
  ...
  struct
    ...
    structure S =
    struct
      datatype t = irwxu | irwxg | irwxo  (* dummy *)
      fun flags (_:t list) = 0x1ff : int (* 0777 *)
    end
    fun inoToWord x = x : word
    val devToWord = inoToWord
  end
end
structure CInterface =
struct
  fun c_function (_:string) (_:string) = SMLSharpOSFileSys.tmpName
end
(* os-filesys.sml
 *
